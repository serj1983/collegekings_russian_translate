...
translate russian v13s29_dd541353:
    ...
    gary "Мои друзья, мои замечательные друзья. Добро пожаловать в автобус травки, или, как я люблю его называть, AmsterDamn."
...
translate russian v13s29_40ac7b59:
    ...
    gary "Сначала я должен разобраться со скучными вещами. Кто купил билеты?"
...
translate russian v13s29_a5d88899:
    ...
    gary "Теперь я должен представиться, меня зовут Гэри Ганджа, Король Травки и т.д."

# game/v13/scene29.rpy:115
translate russian v13s29_6e331bce:

    # u "So, what did we spend our money on...?"
    u "Итак, на что мы потратили наши деньги...?"
...
translate russian v13s29_51853462:
    ...
    gary "Молодой друг, ты заплатил за билет, и ты получишь опыт."
...
translate russian v13s29_8ab56835:
    ...
    am "Я заплатила, чтобы узнать, какая травка самая лучшая, так что давайте приступим к делу."
...
translate russian v13s29_deb99d94:
    ...
    gary "Потому что твои щёки - это то, что будет на тебе после хорошего затяжки этого прекрасного божьего творения."

# game/v13/scene29.rpy:182
translate russian v13s29_78a95b01:

    # am "You gonna let us hit it?"
    am "Вы позволишь нам скрурить его?"

# game/v13/scene29.rpy:187
translate russian v13s29_1c73ae60:

    # gary "How old are you?"
    gary "Сколько тебе лет?"
...
translate russian v13s29_353fcda1:
    ...
    gary "Ненавистник травки в туре по травке, ты странный чувак, друг."

# game/v13/scene29.rpy:283
translate russian v13s29_4112cbe3:

    # u "It wasn't my choice to come."
    u "Это был не мой выбор - поехать."
...
translate russian v13s29_924fc158:
    ...
    gary "Это как волшебство... Я пользуюсь им постоянно. И поверь мне, я знаю, как этим пользоваться."
...
translate russian v13s29_463ae28c:
    ...
    gary "Кто знает, просто подумай о своей бабушке... Мне это помогает."

# game/v13/scene29.rpy:327
translate russian v13s29_be9c1760:

    # u "*Whisper* What the fuck."
    u "*Шёпотом* Что за хрень."
...
translate russian v13s29_14ed434e:
    ...
    gary "Итак, время для урока. Кто здесь поддерживает легализацию марихуаны во всем мире?"
...
translate russian v13s29_f85f77cd:
    ...
    u "Да, я не согласен с этим... Извини."
...
translate russian v13s29_a29fbbc2:
    ...
    gary "Те, кто не поддерживает легализацию, не сумасшедшие и имеют очень справедливое мнение. Несмотря на то, что я люблю травку, я даже не поддерживаю ее легализацию."

# game/v13/scene29.rpy:365
translate russian v13s29_b7f2a68c:

    # am "How the fuck does that work? *Chuckles*"
    am "Как, блядь, это работает? *Хихикает*"
...
translate russian v13s29_3e949e02:
    ...
    gary "Опять же, я люблю это дерьмо, но мы не знаем, как оно влияет на каждую демографическую группу. Молодые и старые, здоровые и больные и т.д."
...
translate russian v13s29_b5cc30cd:
    ...
    gary "Без полного исследования я бы не чувствовал себя комфортно, если бы это было так же доступно, как сигарета. Это было бы в каждой школе вокруг."
...
translate russian v13s29_8b96aef7:
    ...
    am "Просто не то, чего я ожидала. Я думала, что мы накуримся и всё такое."
...
translate russian v13s29_df00af1a:
    ...
    am "*Тяжелое дыхание* Я могу пробежать ещё милю, я заметила, что ты замедлился."

# game/v13/scene29.rpy:532
translate russian v13s29_5353be6d:

    # u "*Heavy breathing* Whatever."
    u "*Тяжелое дыхание* Неважно."
...
translate russian v13s29_5d4ac436:
    ...
    sa "Я не понимаю, почему вы так тяжело дышите, это не так далеко."
