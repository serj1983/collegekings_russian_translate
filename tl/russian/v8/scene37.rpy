...
translate russian v8_tues_evening_565c0af2:
...
translate russian v8s37_phoneContinue2_03be943f:

    # u "(If only something interesting would happen...)"
    u "(Если только случится что-то интересное...)"

# game/v8/scene37.rpy:80
translate russian v8s37_phoneContinue2_565c0af2:

    # u "(I must be imagining things... Or maybe I should just text someone?)"
    u "(Наверное, я что-то себе напридумывал... Или, может, мне стоит просто написать кому-нибудь?)"

# game/v8/scene37.rpy:108
translate russian v8s37_phoneContinue3_6b32f074:

    # u "I should reply to Lauren."
    u "Я должен ответить Лорен"

# game/v8/scene37.rpy:132
translate russian v8s37_phoneContinue4_95d895aa:

    # u "I should reply to my phone."
    u "Я должен глянуть телефон"

# game/v8/scene37.rpy:135
translate russian v8s37_phoneContinue4_0d29d3a6:

    # u "(I guess this is just not my day for studying. Great job, [name]!)"
    u "(Наверное, сегодня просто не мой день для учёбы. Отличная работа, [name]!)"

# game/v8/scene37.rpy:140
translate russian v8s37_phoneContinue4_03be943f:
...
translate russian strings:
    ...
    new "Привет, можешь ли ты помочь мне с учёбой?"
    ...
    new "Я в таком же недоумении, как и тогда, на скамейке..."

    # game/v8/scene37.rpy:31
    old "You texted me just to make that reference, right?"
    new "Ты написал мне только для того, чтобы упомянуть об этом, да?"
    ...
    new "Серьёзно [name], У меня есть дела!"
    ...
    new "Если бы твои ноги были ложью, ты могла бы назвать меня лжецом. Ибо я бы с радостью их раскрывал."

    # game/v8/scene37.rpy:45
    old "That was the most corny, idiotic joke I've ever heard, Mr. Liar. :)"
    new "Это была самая банальная, идиотская шутка, которую я когда-либо слышала, мистер Лжец. :)"

    # game/v8/scene37.rpy:46
    old "Thinking of you makes it harder to study. And in some other places as well..."
    new "Думая о тебе, становится труднее учиться. И в некоторых других местах также..."

    # game/v8/scene37.rpy:47
    old "I'll be the judge of that. :)"
    new "Я буду судьёй в этом :)"

    # game/v8/scene37.rpy:48
    old "Can't wait. :)"
    new "Не могу дождаться :)"

    # game/v8/scene37.rpy:51
    old "I have a serious question to ask you."
    new "У меня к тебе серьёзный вопрос."
    ...
    new "Нужно выбрать между вариантами А и Б."
    ...
    new "Вариант А - целоваться с мистером Ли."

    # game/v8/scene37.rpy:56
    old "B. I choose B. Option B."
    new "Б. Я выбираю Б. Вариант Б."
