...
# game/v8/scene14.rpy:12
translate russian mc_wolves_sun_morn_17079010:

    # u "*Yawn*"
    u "*Зевает*"

# game/v8/scene14.rpy:34
translate russian mc_apes_sun_morn_17079010:

    # u "*Yawn*"
    u "*Зевает*"

# game/v8/scene14.rpy:57
translate russian v8_s14_pen_text_a23d379a:

    # u "(I should reply to her.)"
    u "(Я должен ей ответить.)"

# game/v8/scene14.rpy:60
translate russian v8_s14_pen_text_094c556b:
...
translate russian strings:
    ...
    new "[name] Мне очень страшно! Я в такой беде! Ты мне нужен! Пожалуйста, приезжай!?!"
