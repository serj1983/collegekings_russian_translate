...
translate russian v12s7_free_roam_spoken_c7964da2:
    ...
    u "(Я уже говорил с ними, но я все еще могу убить их)"
...
translate russian v12s7fr_99e1200b:
    ...
    lee "Студенты, пожалуйста, соберитесь. У меня есть что-то очень интересное, чтобы объявить."
...
translate russian v12s7fr_d149b9a8:
    ...
    lee "Во-первых, мне сообщили, что многие из вас не знали, что мы поплывём на пароме, а не полетим."
...
translate russian v12s7fr_995bf04a:
    ...
    lee "Это была корректировка в последнюю минуту, так что я приношу свои извинения. Хотя, я думаю, эта поездка будет стоить того."

# game/v12/scene7.rpy:45
translate russian v12s7fr_37ba52ec:

    # ca "It's costing me a lot of money to look out for you, ya know?"
    ca "Я потратил кучу денег, чтобы присматривать за тобой, понимаешь?"
...
translate russian v12s7fr_5033d044:
    ...
    lee "Как вы все знаете, я горжусь тем, что использую любую возможность для обучения своих студентов, и эта поездка на пароме не будет исключением."
...
translate russian v12s7fr_849ebf66:
    ...
    lee "Десятки лет назад на этом пароме было совершено знаменитое убийство. Убийство, которое мы, в некотором роде, будем изображать."

# game/v12/scene7.rpy:61
translate russian v12s7fr_4b880798:

    # ri "Wait, will we be playing characters?!"
    ri "Подождите, мы будем играть персонажей!"
...
translate russian v12s7fr_f0975ca0:
    ...
    au "Я надеюсь, что это так. Убийство и ролевая игра? Я слишком взволнована... *Хихикает*"

# game/v12/scene7.rpy:71
translate russian v12s7fr_e9e0a07a:

    # ri "*Laughs* I hope you don't have to play a virgin nun."
    ri "*Смеется* Надеюсь, тебе не придется изображать монахиню-девственницу."
...
translate russian v12s7fr_a1e3dff0:
    ...
    lee "Каждому студенту будет отведена определенная роль, потому что мы будем разыгрывать это убийство, играя в загадку убийства."
...
translate russian v12s7fr_9a3afaed:
    ...
    u "(Ну, вы только посмотрите на это. Похоже, у меня на руках будет немного крови.)"
...
translate russian v12s7fr_4686d0f1:
    ...
    lee "На каждой карте есть подробное описание персонажа, которого вы будете играть. А также маркер, говорящий о том, являетесь ли вы убийцей или нет."

# game/v12/scene7.rpy:101
translate russian v12s7fr_856b12e5:

    # imre "Can we please just choose our characters instead?"
    imre "Можем мы выбрать своих персонажей?"
...
translate russian v12s7fr_3d14843e:
    ...
    lee "Вы не можете. Я целенаправленно выбрал роли, которые вы получите."
...
translate russian v12s7fr_b77c3de9:
    ...
    lee "Как я уже сказал, один из вас - убийца, и его задача - убить как можно больше студентов, не будучи пойманным. Как только убийца будет обнаружен, игра закончится."

# game/v12/scene7.rpy:112
translate russian v12s7fr_90519592:

    # imre "Wait, really?"
    imre "Подождите, правда?"
...
translate russian v12s7fr_fe8b62d2:
    ...
    lee "*Вздыхает* Почему это тебя так волнует, Имре?"
...
translate russian v12s7fr_26a92914:
    ...
    imre "Потому что, я выясню, кто убийца, и заставлю их признаться, а потом бум, игра окончена, и я смогу проспать остаток поездки. *Смеется*"
...
translate russian v12s7fr_01013027:
    ...
    imre "Как это невозможно? Это не нарушает никаких правил."
...
translate russian v12s7fr_a5e83c73:
    ...
    lee "На самом деле, так и есть. Студентам будет ЗАПРЕЩЕНО выходить из образа, пока убийца не будет идентифицирован."

# game/v12/scene7.rpy:152
translate russian v12s7fr_326cede8:

    # imre "And what happens if we do?"
    imre "И что произойдет, если мы это сделаем?"

# game/v12/scene7.rpy:157
translate russian v12s7fr_75c9eb73:

    # lee "Do you know how to swim, Imre?"
    lee "Ты умеешь плавать, Имре?"
...
translate russian v12s7fr_6e8b0b75:
    ...
    lee "Хорошо. Потому что после того, как ты решишь выйти из образа, ты вплавь поплывешь в Париж."
...
translate russian v12s7fr_aa201a5d:
    ...
    am "Что, если убийца так и не будет пойман? *Смеется*"
...
translate russian v12s7fr_b77481c0:
    ...
    lee "Это было бы очень впечатляюще и также требовало бы, чтобы убийца был хорошим слушателем, очень проницательным человеком, а также человеком, который может легко вести разговоры."

# game/v12/scene7.rpy:192
translate russian v12s7fr_12929590:

    # lee "Those three are key."
    lee "Это является ключевым."
...
translate russian v12s7fr_25350ad7:
    ...
    au "Ладно, так... Мы получим что-нибудь за это? Кроме того, это весело и чем-то нас отвлекает... *Хихикает*"
...
translate russian v12s7fr_1c416d43:
    ...
    lee "В зависимости от того, насколько хорошо работает убийца и сколько убийств он совершил... Возможно, я смогу придумать какое-нибудь вознаграждение. Но это должно подождать до Амстердама, так как наше расписание в Париже уже очень заполнено."
...
translate russian v12s7fr_2f32c9ce:
    ...
    ry "*Усмехается* Значит, если я не убийца, наша единственная цель - не быть убитым? И мы не получаем за это вознаграждения?"
...
translate russian v12s7fr_95a807aa:
    ...
    lee "Я знаю, что это звучит... несправедливо. В общем, массовое убийство, которое мы сегодня будем воспроизводить, не будет справедливым по отношению к жертвам."
...
translate russian v12s7fr_f4a93cf0:
    ...
    lee "Ваша цель - убедиться, что убийца не получит награду, поймав его как можно скорее."
...
translate russian v12s7fr_392b4bb8:
    ...
    lee "Итак, если убийца получит награду... Я полагаю, что \"приз\" может быть чем-то рассчитанным на двоих. То есть убийца должен будет разделить его с одной из своих жертв... Справедливо?"

# game/v12/scene7.rpy:219
translate russian v12s7fr_e3b7af83:

    # ry "I mean... I guess?"
    ry "То есть... я полагаю?"
...
translate russian v12s7fr_0b5cc114:
    ...
    lee "Позвольте мне еще раз подчеркнуть, НЕ МЕНЯЙТЕ ЛИЧНОСТЬ. Если вы думаете, что вы в безопасности от любопытных глаз и свободны делать все, что пожелаете, то это не так."
...
translate russian v12s7fr_e28aa67a:
    ...
    lee "Вы должны считать, что я всегда нахожусь там и наблюдаю за вами, потому что я буду наблюдать. Если вам есть что сказать, вы должны сказать это в образе."
...
translate russian v12s7fr_5cc8099a:
    ...
    ri "*Южный акцент* И снова богатых низвергают пути ленивых."
...
translate russian v12s7fr_fcddbb1b:
    ...
    lee "Вот почему она моя любимая ученица! Уже играет свою роль богатой женщины."

# game/v12/scene7.rpy:240
translate russian v12s7fr_2f0ff11a:

    # imre "BRO WHAT?! YOU MADE ME SOMEONE'S WIFE?!?!"
    imre "БРО, ЧТО?! ТЫ СДЕЛАЛ МЕНЯ ЧЬЕЙ-ТО ЖЕНОЙ?!?!"
...
translate russian v12s7fr_7312d2da:
    ...
    lee "Я бы не стал смеяться, Райн. Ты играешь его супругу."
...
translate russian v12s7fr_acc49ca1:
    ...
    charli "*Смеется* Добро пожаловать в клуб \"Радужный единорог\"."
...
translate russian v12s7fr_ae3df182:
    ...
    imre "Мне все равно, придется ли мне вести себя как девчонка или нет, я все равно надеру тебе задницу, Чарли."
...
translate russian v12s7fr_eeb14895:
    ...
    lee "Это тоже невозможно. Студенты, пожалуйста, поймите. Как ваш учитель, все вижу и наблюдаю. Ваши личности, ваше взаимодействие друг с другом и так далее."
...
translate russian v12s7fr_919601c5:
    ...
    lee "Роли, которые я выбрал для вас, предназначены для того, чтобы помочь вам или для моего личного удовольствия. Чарли будет играть роль капитана."

# game/v12/scene7.rpy:281
translate russian v12s7fr_38a207f8:

    # charli "Ooh, I like the sound of that. A position of authority."
    charli "О, мне нравится, как это звучит. Позиция власти."
...
translate russian v12s7fr_58539459:
    ...
    lee "И с властью приходит большая ответственность. Таким образом, вы будете ограничены Капитанскими Каютами все время."

# game/v12/scene7.rpy:291
translate russian v12s7fr_f6bacf12:

    # charli "I'm not able to walk around the ship?"
    charli "Я не могу ходить по кораблю?"
...
translate russian v12s7fr_69655a8a:
    ...
    charli "*Насмехается* Тогда как я могу поймать убийцу?"
...
translate russian v12s7fr_8643a3fb:
    ...
    lee "Тебе придется полагаться на свою безопасность, Эмбер. Ты также сможешь делать объявления через ПА."

# game/v12/scene7.rpy:311
translate russian v12s7fr_a2a15790:

    # charli "Hmm, I guess that'll do."
    charli "Хм, думаю, сойдет."
...
translate russian v12s7fr_db2aca54:
    ...
    am "Ах да, я готова сыграть в этом. Я тоже не сдерживаюсь. Это, наверное, худшая роль, которую я могла бы получить."

# game/v12/scene7.rpy:321
translate russian v12s7fr_dddae891:

    # lee "Or the best."
    lee "Или в лучшем случае."
...
translate russian v12s7fr_fd926aac:
    ...
    cl "Так как мы узнаем, кто убийца? Как они будут \"убивать\" людей?"
...
translate russian v12s7fr_4c377cb7:
    ...
    lee "Убийца будет убивать людей, направляя на них фальшивый пистолет. Если тебя убьют, тихо иди в столовую. Не давайте никаких подсказок ни одному из игроков, которые не были убиты."
...
translate russian v12s7fr_e8905f97:
    ...
    lee "Использование любой лазейки как способа саботировать игру приведет к тому, что вас выбросят за борт."

# game/v12/scene7.rpy:346
translate russian v12s7fr_75bbf242:

    # imre "*Chuckles* You can't actually throw us overboard."
    imre "*Хихикает* Вы не можете выбросить нас за борт."
...
translate russian v12s7fr_b41a0021:
    ...
    lee "Ох? Я уверен, что в вашем школьном соглашении говорится, что я могу делать всё, что угодно, с целью обучения, если это не вредит ученикам. И вы определенно получите урок, когда будете преодолевать свой путь в Париж."

# game/v12/scene7.rpy:356
translate russian v12s7fr_f2a7d0fd:

    # imre "Okay, fine. I won't mess up your stupid game."
    imre "Ладно, хорошо. Я не буду портить вашу дурацкую игру."
...
translate russian v12s7fr_a4a9a024:
    ...
    lee "Очень хорошо. Повторяю для всех, убийца может быть пойман только в том случае, если кто-то станет свидетелем преступления. У кого-нибудь есть вопросы?"

# game/v12/scene7.rpy:366
translate russian v12s7fr_ced09284:

    # imre "Umm, is it okay if I just don't play at all?"
    imre "Ничего, если я вообще не буду играть?"
...
translate russian v12s7fr_f2405098:
    ...
    lee "У тебя есть причина пропустить мероприятие, кроме как просто не хотеть?"
...
translate russian v12s7fr_a559506c:
    ...
    lee "Я не дам тебе времени подумать, Имре."
...
translate russian v12s7fr_510064b8:
    ...
    lee "Все будут участвовать. Если это все, то, пожалуйста, возьмите реквизит, соответствующий вашей роли, и наслаждайтесь загадкой убийства."
...
translate russian v12s7_aubrey1_55a53705:
    ...
    au "Привет, красавчик. Пожалуйста, будь осторожен, хорошо? Я бы не хотела, чтобы ты пострадал, но если тебе понадобится любовь и забота, не забудь навестить свою любимую медсестру. *Хихикает*"

# game/v12/scene7.rpy:437
translate russian v12s7_aubrey1_6acc44aa:

    # u "Well, my travelling nurse may get a little jealous."
    u "Ну, моя странствующая медсестра может немного позавидовать."
...
translate russian v12s7_aubrey1_52de15a7:
    ...
    u "Как всемирно известный боксер я постоянно получаю шишки и синяки, поэтому мне приходится путешествовать с медсестрой, но я хотел немного отдохнуть от всех, поэтому ее здесь нет."
...
translate russian v12s7_aubrey1_c2c16c19:
    ...
    u "У меня есть небольшая боль после моего последнего боя, но этого следовало ожидать после того, как весь адреналин выветрился."
...
translate russian v12s7_aubrey1_f94f3d77:
    ...
    au "Ой, бедняжка. Не заставляйте себя сидеть с болью. Я могу помочь снять напряжение, если хочешь?"

# game/v12/scene7.rpy:450
translate russian v12s7_aubrey1_08bc7815:

    # u "*Chuckles* I'm fine, trust me."
    u "*Хихикает* Я в порядке, поверь мне."
...
translate russian v12s7_aubrey1_c821d04b:
    ...
    au "Как скажешь. *Хихикает* Расскажи мне о твоем последнем бое. Я не часто вижу внешний мир, так как постоянно работаю на корабле. Это был большой бой?"
...
translate russian v12s7_aubrey1_b16fed3c:
    ...
    u "Это был серьезный бой. Я удивлён, что вы еще не слышали о нём. Такое ощущение, что весь мир наблюдал."
...
translate russian v12s7_aubrey1_4046006a:
    ...
    u "Нет, это была легкая работа. Ни один бой не является для меня большим боем."
...
translate russian v12s7_aubrey1_d0d40549:
    ...
    u "Так что, как я уже сказал, я уклоняюсь от каждого удара и думаю, что у него ничего нет против меня."
...
translate russian v12s7_aubrey1_08d254e1:
    ...
    u "В итоге я становлюсь немного самоуверенным и опускаю руки, чтобы немного поддразнить его, как вдруг из ниоткуда он наносит мне сильный удар прямо в челюсть."
...
translate russian v12s7_aubrey1_6e7f7767:
    ...
    au "Как вы вернулись и выиграли после того ужасного удара?"
...
translate russian v12s7_aubrey1_64eb6ebe:
    ...
    u "Очевидно, он мог сказать, насколько хорошо он попал в меня, потому что с широкой улыбкой на лице он начал поднимать руки вверх, как будто он выиграл, и это было все, что мне нужно, чтобы прикончить его."

# game/v12/scene7.rpy:527
translate russian v12s7_aubrey1_4d80f7d1:

    # au "*Gasps* Finish him?! *Chuckles*"
    au "*Вздыхает* Прикончить его?! *Хихикает*"
...
translate russian v12s7_aubrey1_e441b188:
    ...
    u "*Хихикает* Я ударил его так сильно, как только мог, прямо в брюхо. Потом еще и еще, пока он даже не смог блокировать."
...
translate russian v12s7_aubrey1_45efec3e:
    ...
    u "Он цеплялся за меня, пытаясь не упасть. Наконец, я нанес последний удар изо всех сил, и он упал на землю, потеряв сознание."
...
translate russian v12s7_aubrey1_a384f93a:
    ...
    au "Боже мой... Я даже представить себе не могу. Ему, должно быть, потребовалась серьезная медицинская помощь после боя."
...
translate russian v12s7_aubrey1_ed067e3d:
    ...
    u "О да. Им пришлось выносить его из того места. Я крепкий сукин сын."
...
translate russian v12s7_aubrey1_52ded90b:
    ...
    au "Думаю, я бы хотела посмотреть, насколько ты крут на самом деле. Я... Кажется, я вижу несколько синяков. О боже, и у тебя глаз порезан! Мне нужно срочно наложить пластырь."
...
translate russian v12s7_aubrey1_35084c47:
    ...
    au "Ох, милый. Если бы я не посмотрела, я бы не смогла называть себя медсестрой. Пожалуйста, зайдите ко мне в кабинет, чтобы я могла вас подлечить."
...
translate russian v12s7_aubrey1_d217aa40:
    ...
    au "Я бы предпочла уединиться подальше от ястребиного глаза мистера Ли, так что побудь со мной в ванной."

# game/v12/scene7.rpy:579
translate russian v12s7_aubrey1_181bf28f:

    # u "Whatever you say Miss Nurse. *Chuckles*"
    u "Как скажете, мисс медсестра. *Хихикает*"
...
translate russian v12s7_aubrey1_40033e41:
    ...
    au "Хорошо, и постарайтесь не затягивать. Эти травмы выглядят очень, очень плохо. *Хихикает*"
...
translate russian v12s7_aubrey1_80057659:
    ...
    u "Хаха, правда? Я даже не почувствовал. После боя я покинул арену и запрыгнул прямо на корабль. У меня даже не было времени взглянуть."
...
translate russian v12s7_aubrey1_4952307a:
    ...
    au "Боже мой... А ты, оказывается, очень крутой. Может, вы защитите меня, кем бы ни был этот убийца?"
...
translate russian v12s7_aubrey2_0dbec01a:
    ...
    au "Правда. А теперь, как насчет того, чтобы сделать загадку убийства немного более... возбуждающей."

# game/v12/scene7.rpy:665
translate russian v12s7_aubrey2_b3f03061:

    # u "Exhilarating? What do you have in mind, doc? *Chuckles*"
    u "Возбуждающей? Что у вас на уме, док? *Смеется*"
...
translate russian v12s7_aubrey2_08a164e9:
    ...
    au "Хаха, нам лучше уйти отсюда, если мы хотим избежать неприятностей. Ты уходи первым, я выйду через несколько минут."
...
translate russian v12s7_aubrey_kill_b272e20d:
    ...
    au "Что? Ах, охххх. *Смеется* Ты убийца. Значит, ты застал красивую, невинную девушку вроде меня одну в ванной и решил ее убить, да?"

# game/v12/scene7.rpy:749
translate russian v12s7_aubrey_kill_8fa6f55d:

    # u "The perfect crime."
    u "Идеальное преступление."
...
translate russian v12s7_aubrey_kill_67ba6516:
    ...
    u "Мы наверстаем позже. Мне еще нужно кое-что посмотреть."
...
translate russian v12s7_aubrey_kill_6266df32:
    ...
    u "Мы наверстаем позже. Мне есть на что посмотреть и кого убить."
...
translate russian v12s7_aubrey_kill_12a1bca8:
    ...
    au "Что случилось, [name]? Ты не хочешь поцеловать красивую девушку-зомби?"

# game/v12/scene7.rpy:772
translate russian v12s7_aubrey_kill_1fb9fb61:

    # u "*Chuckles* I'm good, thanks."
    u "*Хихикает* Спасибо, я в порядке."
...
translate russian v12s7_riley1_67831040:
    ...
    cl "Богатые люди - это настоящая проблема. Вы, ребята, сидите на пачках денег, а маленькие люди, такие как я, должны нести ответственность за всю страну."
...
translate russian v12s7_riley1_f2901d8f:
    ...
    cl "Такие люди, как вы, никогда не хотят платить налоги, но у меня едва хватает двух копеек, и я все равно должен платить свои."
...
translate russian v12s7_riley1_fd527808:
    ...
    ri "*Южный акцент* Вы не становитесь богатым, тратя деньги, вы становитесь богатым, сохраняя их. Если я достаточно умна, чтобы не платить налоги, это значит, что я очень умная бизнес-леди."
...
translate russian v12s7_riley1_9abf1414:
    ...
    cl "Значит, вы позволяете своей жадности создавать бремя для нас, низших классов, и вам всё равно?"
...
translate russian v12s7_riley1_9e48ecf7:
    ...
    ri "*Южный акцент* Послушайте, я знаю, что значит быть бедным. Я носила вашу обувь, но вы понятия не имеете, что значит быть богатым."
...
translate russian v12s7_riley1_03e0c404:
    ...
    ri "Поэтому не судите о жизни, которой вы никогда не жили. Помощь, которую я оказываю на благотворительность, не может сравниться с цифрами в ваших налогах или даже с тем, что вы считаете справедливой долей."

# game/v12/scene7.rpy:827
translate russian v12s7_riley1_0930924d:

    # cl "Hmph, I can't stand rich people."
    cl "Не выношу богатых людей."
...
translate russian v12s7_riley1_511ba944:
    ...
    ri "И я не могу смириться с тем, что я заплатил хорошие деньги за эту поездку, а меня сопровождают такие, как вы."
...
translate russian v12s7_riley1_7df23c65:
    ...
    cl "У вас нет сердца, леди. И что случилось с вашим акцентом? *Хихикает*"
...
translate russian v12s7_riley1_2c407f56:
    ...
    ri "*Южный акцент* Я не знаю, о чем вы говорите. *Хихикает*"
...
translate russian v12s7_riley1_00aa13ae:
    ...
    u "У вас, дамы, найдется место для такого всемирно известного боксера, как я?"
...
translate russian v12s7_riley1_fbfce974:
    ...
    ri "*Южный акцент* Скажи, что глаза меня обманывают! Вы тот самый боец, который победил Гиганта Джорджа Найта."
...
translate russian v12s7_riley1_2298e148:
    ...
    ri "*Южный акцент* И теперь мое замешательство слишком велико. Логично, почему богатые люди и такой человек, как вы, оказались здесь..."
...
translate russian v12s7_riley1_509bfb19:
    ...
    ri "Но я не могу понять, почему Мисс Синий Воротничок разрешили присоединиться к нам."
...
translate russian v12s7_riley1_67aa1ac1:
    ...
    cl "Я уверена, что ему больше понравится мое общество, чем ваше."

# game/v12/scene7.rpy:874
translate russian v12s7_riley1_c075a236:

    # ri "*Shocked* Oh... I see."
    ri "*Шокировано* О... Я вижу."
...
translate russian v12s7_riley1_dc8a40b2:
    ...
    cl "Боксер тоже из скромного рода, и я уверен, что он не так уничижительно, как вы, относится к людям в эти трудные времена."
...
translate russian v12s7_riley1_83f549e3:
    ...
    u "Конечно, мы все можем ужиться вместе, независимо от того, кто мы и откуда."

# game/v12/scene7.rpy:891
translate russian v12s7_riley1_5bdc25d9:

    # ri "*Southern accent* I suppose."
    ri "*Южный акцент* Полагаю, да."
...
translate russian v12s7_riley1_296e16db:
    ...
    cl "Мне уже не о чем говорить. *Хихикает*"
...
translate russian v12s7_riley1_b54c0d6f:
    ...
    ri "*Южный акцент* Этого следовало ожидать. Представители низших классов не знакомы с таким количеством социальных тем, как богатые. Не так ли, мистер Боксер?"
...
translate russian v12s7_riley1_ef6a1d81:
    ...
    u "На самом деле я довольно беден. Мой менеджер забирает почти весь мой выигрыш, и после расходов у меня обычно ничего не остается."
...
translate russian v12s7_riley1_9f53c681:
    ...
    ri "*Южный акцент* Ну, одно только ваше имя ставит вас на более высокий уровень."
...
translate russian v12s7_riley1_5570505d:
    ...
    u "Я горжусь тем, что у меня нет ничего лишнего. У меня есть только то, что мне нужно, и ничего больше. Так что если здесь и есть кто-то посторонний, то это вы."

# game/v12/scene7.rpy:931
translate russian v12s7_riley1_b1935730:

    # ri "*Southern accent* Absurd."
    ri "*Южный акцент* Абсурд."
...
translate russian v12s7_riley1_a9ce0910:
    ...
    u "Пути богатых сильно отличаются от путей бедных. У вас есть парни, которые тренируются бросать мячи, мечтая стать звездой спорта, в то время как мы беседуем о том, как изменить мир."

# game/v12/scene7.rpy:941
translate russian v12s7_riley1_70fc0fbb:

    # cl "But... You yourself are a sports entertainer."
    cl "Но... вы же сами в спорте."
...
translate russian v12s7_riley1_b086eb7b:
    ...
    u "Я давно превзошел мечту, но я была там, где ты и твои люди. Так что я знаю, каково это быть там."

# game/v12/scene7.rpy:951
translate russian v12s7_riley1_7c9a0d27:

    # ri "*Southern accent* As do I."
    ri "*Южный акцент* Как и я."
...
translate russian v12s7_riley1_75d45d31:
    ...
    cl "Ладно, ребята, серьезный разговор. Кто-нибудь из вас видел мистера Ли? Я нет, но после его небольшого представления я начинаю волноваться. Такое ощущение, что за мной наблюдают."
...
translate russian v12s7_riley1_08c982ee:
    ...
    u "Чувствуешь себя немного параноиком, да? Я уверен, что это и было его целью. *Хихикает*"
...
translate russian v12s7_riley1_038c4935:
    ...
    ri "Я бы не стала делать поспешных выводов, но я почти уверена, что у него установлены камеры или что-то в этом роде."

# game/v12/scene7.rpy:971
translate russian v12s7_riley1_c8614a4b:

    # u "You don't think that's a little much?"
    u "Тебе не кажется, что это немного чересчур?"
...
translate russian v12s7_riley1_d8fae3c9:
    ...
    cl "Он всегда серьезно относился к своим историческим штучкам, или что там это должно быть. *Смеется*."
...
translate russian v12s7_riley1_eeda25fd:
    ...
    u "Да, это то, чему я научился на собственном горьком опыте благодаря Имре и Райну."

# game/v12/scene7.rpy:986
translate russian v12s7_riley1_cfd302f9:

    # cl "Wait, what happened?"
    cl "Подожди, что случилось?"
...
translate russian v12s7_riley1_93dc6c71:
    ...
    u "Короче говоря, когда мы были в Лондоне и они поссорились в отеле, мистер Ли попытался заставить их помириться."
...
translate russian v12s7_riley1_c07db538:
    ...
    u "Вы, наверное, догадываетесь, что они не послушали его, и Он. Был. Взбешён. Прогулка обратно в отель из глуши была, вероятно, вполне заслуженной."

# game/v12/scene7.rpy:997
translate russian v12s7_riley1_0d091282:

    # cl "*Laughs* Yeah, that's the Mr. Lee I know."
    cl "*Смеется* Да, это тот мистер Ли, которого я знаю."
...
translate russian v12s7_riley1_99798f4f:
    ...
    ri "Если мы не вернемся в образ, то, скорее всего, он снова взбесится. *Хихикает*"

# game/v12/scene7.rpy:1007
translate russian v12s7_riley1_b8f5d1cc:

    # u "Have you two found any hints on who may be the murderer?"
    u "Вы двое нашли какие-нибудь намеки на то, кто может быть убийцей?"
...
translate russian v12s7_riley1_4eff5c0c:
    ...
    cl "Честно говоря, мы просто возились с нашими персонажами. Мне даже стало нравиться, когда Райли здесь ведет себя серьезно и вздорно. *Хихикает*"

# game/v12/scene7.rpy:1017
translate russian v12s7_riley1_21040461:

    # ri "What if I wasn't acting? *Chuckles* Uh, oh!"
    ri "А если бы я не играла? *Хихикает* Ух, ох!"
...
translate russian v12s7_riley1_60992e76:
    ...
    u "Хорошо, дамы. Наслаждайтесь своими маленькими дебатами между богатыми и бедными Я должен идти бить грушу. *Хихикаете*"
...
translate russian v12s7_riley1_551d362e:
    ...
    u "Раз уж вы так увлечены этим делом, мисс Рич, может, вам стоит помочь найти убийцу?"
...
translate russian v12s7_chloe1_467b0107:
    ...
    u "Вовсе нет. Мы все богаты по-своему, и посмотрите на себя, вы явно богаты красотой."
...
translate russian v12s7_chloe1_a7c61d50:
    ...
    cl "Если ты просто пытаешься подмаслить меня, чтобы подло убить, продолжай. *Хихикает* Мне приятны комплименты... Тяжело быть бедной."
...
translate russian v12s7_chloe1_d78f032e:
    ...
    u "Быть бедным - это не более чем залог богатства, потому что никто не выбирает быть бедным. Вот почему я жертвую половину всех своих доходов от боев тем, кто в них нуждается."

# game/v12/scene7.rpy:1115
translate russian v12s7_chloe1_734eed17:

    # cl "Oh, so you're a generous type of man."
    cl "О, вы такой щедрый человек."
...
translate russian v12s7_chloe1_552adf0b:
    ...
    u "Как я могу не быть таким? После взгляда в твои глаза мне кажется, что я стал свидетелем греческой трагедии."

# game/v12/scene7.rpy:1125
translate russian v12s7_chloe1_9e049f37:

    # cl "Haha, okay. Mr. Lee is definitely getting to you."
    cl "Хаха, хорошо. Мистер Ли определенно добрался до тебя."
...
translate russian v12s7_chloe1_88c97af5:
    ...
    u "Я подумал об этом только потому, что он заставлял нас делать это в классе. *Хихикает*"
...
translate russian v12s7_chloe1_1d24c766:
    ...
    cl "Что общего между викингами и греками? *Хихикает*"
...
translate russian v12s7_chloe1_9a9f8459:
    ...
    u "Хаха, я понятия не имею. Итак, наша бедная девочка готова к Европе или она начинает скучать по дому?"

# game/v12/scene7.rpy:1145
translate russian v12s7_chloe1_507229dd:

    # cl "Hmm... A little bit of both I guess?"
    cl "Хмм... Немного того и другого?"
...
translate russian v12s7_chloe1_656cb66c:
    ...
    cl "Я рада увидеть Париж, я всегда хотела это сделать, но должна признать, что иногда я чувствую себя не в своей тарелке, учитывая, что мы в совершенно другой стране."
...
translate russian v12s7_chloe1_29836252:
    ...
    u "Как боец, я объездил весь мир, но никогда не мог заменить дом. Это точно."
...
translate russian v12s7_chloe1_b5757e27:
    ...
    u "Что происходит в твоей белокурой голове? *Хихикает*"
...
translate russian v12s7_chloe1_69882701:
    ...
    cl "*Хихикает* Просто... Я знаю, что как только мы вернемся, вся эта история с Чикс взорвется, и я очень надеюсь, что смогу справиться со всем этим. Даже если я справлюсь, это все равно будет очень напряженно."
...
translate russian v12s7_chloe1_26142229:
    ...
    u "Может быть, ты сможешь составить план, чтобы, когда вернешься, ты была хотя бы морально готова."
...
translate russian v12s7_chloe1_1c4665dc:
    ...
    cl "Я думала об этом, но я хочу насладиться поездкой. Это может быть последнее, чем я смогу насладиться, прежде чем ситуация с Чикс взорвётся у меня прямо под носом."
...
translate russian v12s7_chloe1_34061843:
    ...
    u "Да, я понимаю. Было бы не слишком весело планировать апокалипсис Чикс, находясь в Европе. *Хихикает*"
...
translate russian v12s7_chloe1_b556d21f:
    ...
    cl "Именно. Так что, я не знаю. Я делаю все возможное, чтобы не думать об этом..."
...
translate russian v12s7_chloe1_216afb1f:
    ...
    cl "Ладно... Я знаю, что это не по теме, но я просто подумала кое о чем. Что если мистер Ли подслушивает реквизит и поэтому он всегда начеку."
...
translate russian v12s7_chloe1_76e4de5e:
    ...
    u "Вообще-то, это неплохая теория."
...
translate russian v12s7_chloe1_3e64dfda:
    ...
    cl "На случай, если вы слушаете Мистер Ли, мой персонаж \"бедная девочка\" столкнулась с проблемами в женском сообществе дома, и ей нужно было выговориться..."

# game/v12/scene7.rpy:1224
translate russian v12s7_chloe1_12a7d733:

    # u "Wow... *Chuckles* You're actually scared of Mr. Lee."
    u "Вау... *Хихикает* Ты боишься Мистера Ли."
...
translate russian v12s7_chloe1_a5b69879:
    ...
    cl "*Шёпот* Он был очень груб со мной, когда он был моим учителем. Это было отчасти моей виной, но все же."
...
translate russian v12s7_chloe1_1f672a09:
    ...
    cl "Этот человек безжалостен, когда ты не делаешь то, что он просит. я не знаю, биполярно ли он или просто не любит, когда ему не подчиняются."

# game/v12/scene7.rpy:1235
translate russian v12s7_chloe1_d1a7593a:

    # u "Haha, probably a bit of both..."
    u "Ха-ха, возможно и то и другое..."
...
translate russian v12s7_chloe1_333fc136:
    ...
    cl "*Смеется* Итак... Ты пришёл поговорить со мной дважды. Откуда ты знаешь, что я не убийца?"
...
translate russian v12s7_chloe1_b68d392c:
    ...
    cl "Единственный способ узнать это - если бы ты был убийцей."
...
translate russian v12s7_chloe1_c7435c1f:
    ...
    u "Или... Я знаю, кто убийца, но не собираюсь доносить, потому что, во-первых, я не доносчик, а во-вторых, я не в настроении быть выброшенным за борт за то, что назвал человека, не будучи свидетелем убийства. Бум."
...
translate russian v12s7_chloe1_89dc8e77:
    ...
    cl "*Хихикает* Это было довольно убедительно, ты записал это?"
...
translate russian v12s7_chloe1_5f64cc2d:
    ...
    u "Эй, если ты не общалась с другими людьми, это не значит, что ты можешь считать, что это я. *Смеется*"
...
translate russian v12s7_chloe1_2eb9b69b:
    ...
    cl "Видеть - значит верить, а я видела только тебя и Райли. И я думаю, мы оба знаем, что она не убийца."
...
translate russian v12s7_chloe1_028f8188:
    ...
    u "Но так ли это? Возможно, она затягивает все это только для того, чтобы продолжить игру, хаха."
...
translate russian v12s7_chloe1_1db3bf4f:
    ...
    cl "Вообще-то, это хорошая мысль... Ладно, теперь я не так уверена в том, что ты убийца. *Хихикает*"
...
translate russian v12s7_chloe1_7ed963e7:
    ...
    cl "Если я... сделаю что-то для тебя, ты скажешь мне? Немного, услуга за услугу?"
...
translate russian v12s7_chloe1_3bcfab05:
    ...
    u "Есть только один способ узнать, кто убийца... Вы просто должны поймать его на месте преступления."
...
translate russian v12s7_chloe_kill_53a20657:
    ...
    cl "*Улыбается* Ты подлая маленькая змея. Ты был убийцей все это гребаное время, и я знала это."

# game/v12/scene7.rpy:1374
translate russian v12s7_chloe_kill_964577fe:

    # u "Haha, how'd you know?"
    u "Хаха, откуда ты знала?"
...
translate russian v12s7_chloe_kill_3cb1964a:
    ...
    cl "Потому что мистер Ли уже разыгрывал загадку убийства, и он всегда выбирает убийцу из одного и того же типа студентов."

# game/v12/scene7.rpy:1384
translate russian v12s7_chloe_kill_b9c00daa:

    # u "Wait, really? *Laughs* And what type of student is that?"
    u "Подожди, правда? *Смеется* И что это за тип студентов?"
...
translate russian v12s7_chloe_kill_f9c9e2eb:
    ...
    cl "Студент, который знает всех, имеет много друзей, много врагов, и в целом просто уравновешенный студент."
...
translate russian v12s7_chloe_kill_3211eba2:
    ...
    u "Что ж, спасибо, я думаю... хорошо ли быть уравновешенным?"
...
translate russian v12s7_chloe_kill_f36e6919:
    ...
    cl "Это для меня. *Смеется* Я не могу поверить, что ты только что убил меня!"
...
translate russian v12s7_chloe_kill_986333c2:
    ...
    u "Думай об этом так: Чем быстрее я убью, тем быстрее все закончится."
...
translate russian v12s7_chloe_kill_ed03f101:
    ...
    cl "Да, да, неважно. Иди и закончи свою резню, мистер Боксер."
...
translate russian v12s7_riley3_af0f6b04:
    ...
    u "Видеть вас снова вместе в одном и том же месте немного подозрительно."
...
translate russian v12s7_riley3_ae2f886f:
    ...
    ri "*Хихикает* *Южный акцент* Конечно, проверяй нас, партнер! Я видела, как ты вырубаешь мужчин на ринге..."
...
translate russian v12s7_riley3_d9a642c5:
    ...
    ri "Мне всегда было интересно, удавалось ли вашим оппонентам выйти оттуда живыми, а теперь я начинаю сомневаться, удастся ли это нам. Вы убийца, мистер Боксер?"
...
translate russian v12s7_riley3_f7ceb7d1:
    ...
    cl "Я и так подозревала его, но теперь у меня нет никаких сомнений."

# game/v12/scene7.rpy:1454
translate russian v12s7_riley3_56c44c47:

    # u "What have I done that makes me look like the killer?"
    u "Что я сделал такого, что делает меня похожим на убийцу?"
...
translate russian v12s7_riley3_68810acd:
    ...
    cl "О, я не знаю. Предлагаете людям пойти побродить вокруг, заставляя нас разделиться?"
...
translate russian v12s7_riley3_4bebd56d:
    ...
    u "Ладно, я понимаю, как это может быть подозрительно. Но, как всегда, невиновен, пока не доказана вина."
...
translate russian v12s7_riley3_ea1f6bf8:
    ...
    u "И вы обе на меня давите, так откуда мне знать, что это не один из ваших планов отвлечь внимание?"
...
translate russian v12s7_riley3_e17f70f5:
    ...
    ri "*Южный акцент* Хм, наша маленькая синяя воротничка может быть убийцей. Ты убийца, девочка?"
...
translate russian v12s7_riley3_3212afc4:
    ...
    ri "*Южный акцент* Почему тогда \"умм\", милая?"
...
translate russian v12s7_riley3_cf32dcfb:
    ...
    cl "Я просто немного шокирован тем, что вы думаете, что это я, поскольку я была здесь, на том же месте, всё это время. *Хихикает*"
...
translate russian v12s7_riley3_91e99147:
    ...
    u "Есть и другие люди, играющие в эту игру, и многое происходит за пределами того, что делаем мы трое. Почему вы, ребята, так узко мыслите?"
...
translate russian v12s7_riley3_3e4b0ab8:
    ...
    ri "*Южный акцент* Хм, думаю, ты прав. Кто еще?"
...
translate russian v12s7_riley3_56c382dd:
    ...
    ri "Имре и Райн преследуют друг друга. Так что было бы очень странно, если бы один из них был убийцей, и к тому же, я не думаю, что мистер Ли выбрал бы из них."

# game/v12/scene7.rpy:1501
translate russian v12s7_riley3_7fb12ba9:

    # u "Who would you least expect?"
    u "Кого вы меньше всего ожидаете?"
...
translate russian v12s7_riley3_f4b45313:
    ...
    cl "Хорошо, но... Это не значит, что мы признали тебя невиновным. Это значит, что мы изучаем другие варианты. Не клади все яйца в одну корзину, верно?"
...
translate russian v12s7_riley3_f803fd00:
    ...
    ri "*Южный акцент* Это правило, по которому могут жить и бедные, и богатые."
...
translate russian v12s7_riley3_d306ce59:
    ...
    u "На мне есть надпись \"убийца\" или что-то в этом роде? *Хихикает* Я ничего не сделал."
...
translate russian v12s7_riley3_c312c714:
    ...
    ri "*Южный акцент* \"Тактика\"? По-моему, это звучит как термин для заговора убийцы..."
...
translate russian v12s7_riley3_d9c65aec:
    ...
    u "Нет, я просто имел в виду... Знаешь что, не бери в голову. *Хихикает* Я дам вам двоим проветрить мозги."
...
translate russian v12s7_riley3a_cc79a877:
    ...
    ri "*Южный акцент* Я - да, но я не уверена, что наша бедная девочка - да. Я знаю, что она планировала остаться на том же месте, но теперь она ушла."
...
translate russian v12s7_riley3a_77d67edd:
    ...
    ri "*Южный акцент* Но кто? Если ее убили, то это должен быть кто-то, кто передвигается. Основываясь на том, что я слышала, как Имре сказал ранее, я должна предположить, что это он."
...
translate russian v12s7_riley3a_6d45e4ef:
    ...
    ri "*Южный акцент* Имре сказал, что он просто поторопится и сделает так, чтобы всех убили."

# game/v12/scene7.rpy:1612
translate russian v12s7_riley3a_b217a91d:

    # u "(How is he gonna do that? *Laugh*)"
    u "(Как он собирается это сделать? *Смеется*)"
...
translate russian v12s7_riley3a_ab076092:
    ...
    u "Это звучит подозрительно, возможно, мне стоит проверить их и посмотреть, что я смогу выяснить."
...
translate russian v12s7_riley3a_3eec572d:
    ...
    ri "*Южный акцент* Подожди минуту. Ты был здесь с Хлоей, когда я ушла, что она сказала, пока меня не было?"
...
translate russian v12s7_riley3a_3f746669:
    ...
    u "Честно говоря, она думала, что это я, но я не могу ее винить, поскольку мы с тобой были единственными людьми, с которыми она разговаривала. Она должна кого-то обвинить. *Хихикает*"
...
translate russian v12s7_riley3a_369a9a0b:
    ...
    ri "*Южный акцент* Кто-то другой должен был зайти, когда никого из нас не было с ней."
...
translate russian v12s7_riley3a_58f7df7f:
    ...
    u "Она приняла тебя за убийцу и решила, что ты играешь так жестко, чтобы сбить людей с толку."
...
translate russian v12s7_riley3a_ef5ee703:
    ...
    ri "*Шепот* Эй, я не играю жёстко. Я просто не хочу нарываться на неприятности и хочу сказать, что мне нравятся такие вещи."
...
translate russian v12s7_riley3a_7692830b:
    ...
    ri "Ты должен признать, Мистер Ли создает очень интерактивные ситуации для нас, студентов. Я ценю это."
...
translate russian v12s7_riley3a_7ff7dfd2:
    ...
    ri "*Шепот* Тебе нужно пойти проверить Имре и Райна, вы же друзья. Если Имре правда убийца, ты сможешь его вычислить."
...
translate russian v12s7_riley_kill_e12b8f97:
    ...
    ri "Как я могла не знать? Так много людей думали, что это Имре. Как месть за мистера Ли или что-то в этом роде. *Хихикает*"

# game/v12/scene7.rpy:1701
translate russian v12s7_riley_kill_b7f2741f:

    # u "Nope, it was the beautiful famous boxer. *Laughs*"
    u "Нет, это был прекрасный знаменитый боксер. *Смеется*"
...
translate russian v12s7_riley_kill_a5722188:
    ...
    ri "Вау, ну, я думаю, раз ты убил меня, теперь я могу болеть за тебя. Так что удачи."
...
translate russian v12s7_lauren1_329fc1fb:
    ...
    la "Не пытайся использовать игру, чтобы поговорить со мной."
...
translate russian v12s7_lauren1_869da1db:
    ...
    u "(Черт, она все еще очень злится.)"
...
translate russian v12s7_lauren1_912a7922:
    ...
    u "Да, я знаю, что ты сейчас злишься, но я должен играть в игру, так что..."
...
translate russian v12s7_lauren1_cde98005:
    ...
    la "Не удивительно, что тебя выбрали убийцей, мистер Ли должен знать самого плохого парня."
...
translate russian v12s7_lauren1_f136150e:
    ...
    la "Потому что это мой персонаж, он убийца в бегах."
...
translate russian v12s7_lauren1_17522a2c:
    ...
    u "*Смеется* Подожди, твой персонаж - убийца в бегах, но ты говоришь, что не убийца? Я не знаю, могу ли я в это поверить."
...
translate russian v12s7_lauren1_207c4706:
    ...
    la "Видишь! Ты и все остальные, я не знаю, почему мистер Ли так поступил. Никто не подходит ко мне, потому что не хочет быть убитым. Кроме Имре, он умолял меня убить его, хаха."
...
translate russian v12s7_lauren1_396fca44:
    ...
    u "Я не знаю... Что если ты просто достаточно умна, чтобы придумать эту историю?"
...
translate russian v12s7_lauren1_c22079c7:
    ...
    la "Если ты думаешь, что я убийца, тогда почему ты рядом со мной, а? Единственные люди, которые меня окружают, либо хотят быть убитыми, либо являются убийцами, потому что они могут легко меня убить."

# game/v12/scene7.rpy:1860
translate russian v12s7_lauren1_dd72dbd1:

    # u "Okay, good point. Are you asking me to leave then?"
    u "Хорошо, хорошая мысль. Тогда ты просишь меня уйти?"
...
translate russian v12s7_lauren1_bbde7276:
    ...
    la "Нет, я не просто так это говорю, ой, неважно. Даже если бы ты был убийцей, мне было бы все равно, но, по крайней мере, проведи со мной немного времени, прежде чем убить меня."

# game/v12/scene7.rpy:1870
translate russian v12s7_lauren1_1bdd12d0:

    # u "Aww, are you really that lonely? *Chuckles*"
    u "Неужели тебе так одиноко? *Хихикает*"
...
translate russian v12s7_lauren1_fe7af17e:
    ...
    la "Звучит грустно, когда ты так говоришь, мне просто не нравится, когда все избегают меня."
...
translate russian v12s7_lauren1_8b340717:
    ...
    u "Похоже, у Мистера Ли было множество мотивов для ролей, которые он нам дал."
...
translate russian v12s7_lauren1_a94e61ae:
    ...
    la "Это бы объяснило, почему он был так серьезен насчет того, чтобы мы не нарушали образ."
...
translate russian v12s7_lauren1_05bb8ded:
    ...
    u "И он присматривает за всеми нами, вместо того, чтобы играть роль."
...
translate russian v12s7_lauren1_27ef83f6:
    ...
    la "Почему тогда боксер для тебя? Не похоже, что он беспокоится о братстве."
...
translate russian v12s7_lauren1_cebdbdd0:
    ...
    u "Я не думаю, что это как-то связано с этим, я на самом деле не уверен в своей роли. Но все остальные, кажется, имеют личный конфликт или серьезную забаву в своей роли."
...
translate russian v12s7_lauren1_4ee84a1d:
    ...
    la "Да, у Эмбер есть охрана или что-то в этом роде, и она этим пользуется. она взяла мою жвачку раньше, после того как обыскала меня, сказав, что это контрабанда. *Смеется*"
...
translate russian v12s7_lauren1_79bf7585:
    ...
    la "Я много чего хочу сделать, я дала себе несколько обещаний и собираюсь их выполнить."
...
translate russian v12s7_lauren1_321cbce3:
    ...
    u "Ты довольно философски настроены для убийцы в бегах. *Хихикает*"
...
translate russian v12s7_lauren1_34299b69:
    ...
    la "Знаешь что, иди побеспокойся о ком-нибудь другом. *Хихикает* Может, кто-нибудь убьет тебя за меня. *Смеется*"

# game/v12/scene7.rpy:1942
translate russian v12s7_lauren1_1e71fa36:

    # la "At least kiss me first before you die."
    la "Хотя бы поцелуй меня сначала, прежде чем умрешь."

# game/v12/scene7.rpy:1952
translate russian v12s7_lauren1_157edc12:

    # u "Off to die, bye."
    u "Пойду умирать, пока."
...
translate russian v12s7_lauren_kill_30b6639d:
    ...
    la "Ух ты, ты вот так просто собираешься меня убрать. Моя жизнь в качестве подозреваемого преступника была недостаточно плоха?"

# game/v12/scene7.rpy:1988
translate russian v12s7_lauren_kill_a92f89c2:

    # u "I thought I'd end your misery for you."
    u "Я решил покончить с твоими страданиями за тебя."
...
translate russian v12s7_lauren_kill_1c1bb58c:
    ...
    u "Мы, преступники, должны поддерживать друг друга."
...
translate russian v12s7_ryan_imre1_006c5605:
    ...
    ry "Вау, посмотрите на этот прекрасный день, если бы только моя жена была такой же красивой."
...
translate russian v12s7_ryan_imre1_e3977209:
    ...
    imre "Просто немного поспорила с мужем. Он любит отпускать злые шуточки."

# game/v12/scene7.rpy:2050
translate russian v12s7_ryan_imre1_77268185:

    # lee "Mhm, as long as you're enjoying yourselves."
    lee "Мхм, до тех пор, пока вы наслаждаетесь собой."
...
translate russian v12s7_ryan_imre1_ddf6c6e3:
    ...
    ry "Конечно, да, просто моя любимая жена время от времени не понимает моего юмора. У него, то есть у нее, иногда мозги как у курицы."

# game/v12/scene7.rpy:2060
translate russian v12s7_ryan_imre1_d9510c4e:

    # imre "Ha ha ha, that's so funny. Look at me laughing."
    imre "Хахаха, это так забавно. Посмотрите, как я смеюсь."
...
translate russian v12s7_ryan_imre1_c547f565:
    ...
    ry "Остынь, я не виноват, что нам приходится это делать. Я не за то, чтобы бить женщин, но я выбью из тебя всё дерьмо."
...
translate russian v12s7_ryan_imre1_d09fb4a9:
    ...
    u "Вы двое - идиоты, это самое смешное, что я видел за всю свою жизнь, я наблюдал за вами последние пять минут."
...
translate russian v12s7_ryan_imre1_6a9e18ed:
    ...
    imre "Это не должно быть смешно. Я делаю это, потому что думаю, что учитель может выбросить меня за борт."
...
translate russian v12s7_ryan_imre1_7624addf:
    ...
    ry "Он ходит за нами, потому что моя жена не хочет оставаться в образе."
...
translate russian v12s7_ryan_imre1_33f5500f:
    ...
    ry "Мы - настоящая пара. Мы - Сторки и мы из Южной Африки, исследуем мир вместе. Притягательность этого корабля настолько привлекла нас, что мы решили отправиться на нем в медовый месяц."

# game/v12/scene7.rpy:2140
translate russian v12s7_ryan_imre1_e752d407:

    # u "*Chuckles* So this is your honeymoon?"
    u "*Хихикает* Так это ваш медовый месяц?"

# game/v12/scene7.rpy:2145
translate russian v12s7_ryan_imre1_8ab8c88e:

    # ry "Yep, we're proud newlyweds."
    ry "Да, мы гордые молодожены."
...
translate russian v12s7_ryan_imre1_a85d384a:
    ...
    u "Что ж, позвольте поздравить милую пару! Не стесняйтесь прийти на мой следующий бой в качестве ВИП-персон. Я обязательно внесу вас в список как Мистер и Миссис Сторк.
"
...
translate russian v12s7_ryan_imre1_e55bbe8e:
    ...
    u "Как бы смешно это ни было, остынь немного, Райн. Ты бы не был так счастлив, если бы играл жену. Уверен, что Имре отнесся бы к тебе хорошо."
...
translate russian v12s7_ryan_imre1_85989468:
    ...
    imre "Следи за тем, что говоришь! По крайней мере, сопровождай их словами \"без гомосятины\" или что-то в этом роде!"
...
translate russian v12s7_ryan_imre1_76582d73:
    ...
    u "*Смеется* Виноват, ребята, вы должны прийти на мой следующий бой в качестве VIP-персон. Это за мой счет."

# game/v12/scene7.rpy:2201
translate russian v12s7_ryan_imre1_a9e5ae83:

    # imre "Yeah, we won't be going."
    imre "Да, мы не пойдем."
...
translate russian v12s7_ryan_imre1_6af7345d:
    ...
    ry "Он всегда подстрекал меня, а теперь все перевернулось."
...
translate russian v12s7_ryan_imre1_bfc67707:
    ...
    u "Эй, не связывайся с ним. Я не удивлюсь, если он ударит тебя."
...
translate russian v12s7_ryan_imre1_b42afb85:
    ...
    ry "Хаха, может, я и не стану знаменитым боксером, но я буду в полном порядке."
...
translate russian v12s7_ryan1_2165b9d1:
    ...
    u "Ваша жена до сих пор не вернулась?"
...
translate russian v12s7_ryan1_815d7b65:
    ...
    ry "Неа, и мистера Ли я тоже не видел, так что я просто жду здесь. *Хихикает*"

# game/v12/scene7.rpy:2312
translate russian v12s7_ryan1_b7fcac5f:

    # u "Wow, you guys just won't ever get along, huh?"
    u "Вы, ребята, просто никогда не сможете найти общий язык, да?"
...
translate russian v12s7_ryan1_fd90e59b:
    ...
    ry "Наверное, нет. Я могу смириться с тем, что мы в разных братствах, но я не могу смириться с его неуважением. Я знаю, что он твой друг и не против тебя, но он не против меня."

# game/v12/scene7.rpy:2322
translate russian v12s7_ryan1_dc2ac04e:

    # u "Ever thought about just apologizing to squash the beef?"
    u "Вы когда-нибудь думали о том, чтобы просто извиниться?"
...
translate russian v12s7_ryan1_7b7e1902:
    ...
    ry "Нет, не совсем, честно говоря, это единственное, что не давало мне скучать в этой поездке."

# game/v12/scene7.rpy:2342
translate russian v12s7_ryan1_f6e7031d:

    # u "You're not enjoying Europe?"
    u "Тебе не нравится Европа?"
...
translate russian v12s7_ryan1_28bf2d7e:
    ...
    ry "Ну, есть кое-кто, кто делает это немного лучше."
...
translate russian v12s7_ryan1_4da23ece:
    ...
    ry "Нет, все мои друзья вернулись в кампус."
...
translate russian v12s7_ryan1_4d3fc017:
    ...
    u "Ну, мы пробудем в Париже совсем немного, а после этого у нас будет еще одна остановка, так что вам определенно стоит попробовать и насладиться им, пока вы здесь."
...
translate russian v12s7_ryan1_a5315aa8:
    ...
    ry "Честно говоря, я не знаю, как еще я могу сыграть эту роль, не продолжая злить Имре. *Хихикает*"

# game/v12/scene7.rpy:2371
translate russian v12s7_ryan1_6afe8459:

    # u "Yeah, it does seem to be part of your role."
    u "Да, похоже, это часть твоей роли."
...
translate russian v12s7_ryan1_72c78c6d:
    ...
    ry "Он чувствителен ко всем геям, поэтому его так легко беспокоить. Я сказал ему, что не могу ждать до вечера, что я собираюсь показать ему хорошее время."
...
translate russian v12s7_ryan1_10f21fd7:
    ...
    ry "Если бы мистера Ли не было рядом, я не знаю, что бы он сделал, но его лицо стало очень красным. *Смеется*"
...
translate russian v12s7_ryan1_f01591d2:
    ...
    u "*Смеется* Будь осторожна, в конце концов, все закончится, и он больше не будет беспокоиться о мистере Ли. Он может сам выбросить тебя за борт."

# game/v12/scene7.rpy:2387
translate russian v12s7_ryan1_79b4a6f3:

    # ry "That would suck. I can barely swim."
    ry "Это было бы отстойно. Я едва умею плавать."
...
translate russian v12s7_ryan1_e398450d:
    ...
    ry "Что значит \"что\"? Есть много взрослых, которые не умеют плавать, и я не говорю, что я не умею, я говорю, что я едва умею."

# game/v12/scene7.rpy:2402
translate russian v12s7_ryan1_b9898d16:

    # u "*Laughs* How do you barely know how to swim?"
    u "*Смеется* Как это ты едва умеешь плавать?"
...
translate russian v12s7_ryan1_4282e782:
    ...
    ry "Так я никогда раньше не плавал, но я уверен, это не так уж и сложно."

# game/v12/scene7.rpy:2412
translate russian v12s7_ryan1_9dbaecde:

    # u "YOU'VE NEVER BEEN SWIMMING?"
    u "ТЫ НИКОГДА НЕ ПЛАВАЛ?"
...
translate russian v12s7_ryan1_fdd94041:
    ...
    ry "Бро, почему ты кричишь? Нет, я раньше не плавал. Не вижу в этом ничего особенного."
...
translate russian v12s7_ryan1_698e599c:
    ...
    u "Может быть, потому что мы живем в Калифорнии рядом с океаном?"
...
translate russian v12s7_ryan1_163f9415:
    ...
    ry "Я не очень люблю океан. Ты знаешь, что мы открыли только пять процентов его? Никто не знает, что там есть, и я не собираюсь быть кормом для рыб."
...
translate russian v12s7_ryan1_c53b1b1c:
    ...
    u "Хаха, пойду сообщу мистеру Ли, что ты хочешь залезть в воду."
...
translate russian v12s7_ryan_kill_e47fd058:
    ...
    ry "О, черт, это здорово. Единственное, в чем мы с Имре согласны, так это в том, чтобы завершить эту игру, так что поторопись и убей всех."
...
translate russian v12s7_imre2_f12b8d87:
    ...
    imre "Это не беспокоит меня больше, чем беспокоило бы кого-либо другого. Вы, ребята, ведёте себя так, будто я на самом деле гей или что-то в этом роде."

# game/v12/scene7.rpy:2528
translate russian v12s7_imre2_ca21c5f3:

    # u "I don't think that's what anyone is doing. *Chuckles*"
    u "Я не думаю, что кто-то так считает. *Хихикает*"
...
translate russian v12s7_imre2_015f9bb4:
    ...
    imre "Да, так и есть, и мы оба знаем, что это далеко не так. Я всегда был и всегда буду дамским угодником."
...
translate russian v12s7_imre2_228ec0aa:
    ...
    u "Если ты не можешь понять шутку, то ты выглядишь глупо."
...
translate russian v12s7_imre2_321684f4:
    ...
    imre "Нет, это не так, это должно быть известно, что я не зажигаю так. Ты, Чарли и Райн могут думать, что это все веселье и игры, но это не так."
...
translate russian v12s7_imre2_2ee22002:
    ...
    u "Если это беспокоит тебя, я могу попробовать и вернуть его обратно, но не могу ничего обещать. *Хихикает* По крайней мере, не во время игры."
...
translate russian v12s7_imre2_ee871324:
    ...
    imre "Да хрен с ним. Мистер Ли делает всё, чтобы поиметь меня."
...
translate russian v12s7_imre2_d4a58972:
    ...
    imre "Ф-Ф-Ф. Он дал мне худший персонаж, он преследует меня повсюду и угрожает бросить меня в чертову воду. Да, он пделает это, чтобы быть мудаком."
...
translate russian v12s7_imre2_1db02e63:
    ...
    imre "Если бы меня здесь не было, вы бы сейчас лежали, наслаждаясь бризом. Если бы гребаный убийца сделал свою работу или поторопился и был пойман, все бы наконец закончилось."
...
translate russian v12s7_imre2_01c02c6f:
    ...
    u "Думаю, это значит, что вы не нашли убийцу и не являетесь им."
...
translate russian v12s7_imre2_8209c6af:
    ...
    imre "Я ничего не могу сделать, потому что мистер Ли не даёт мне дышать. Он отвлекся, и это дало мне шанс добраться сюда. Он еще не нашел меня."
...
translate russian v12s7_imre2_31e1da3a:
    ...
    imre "Если бы убийца просто убил меня, чтобы я мог покончить с этим, было бы здорово. Тогда Райн сможет быть тупым вдовцом без работы в круизе в одиночестве, слоняясь как идиот."
...
translate russian v12s7_imre2_bb60348b:
    ...
    imre "Это первый раз, когда я сказал \"убей меня сейчас\" и на самом деле имел это в виду.  *Смеётся*"
...
translate russian v12s7_imre_kill_eefed9e7:
    ...
    u "Бро тише. *Хихикает* У меня есть еще люди, которых нужно убить."
...
translate russian v12s7_imre_kill_323444b0:
    ...
    imre "Извини мужик, но мне сейчас так хорошо. Приятно быть мертвым. Спасибо."
...
translate russian v12s7_lindsey2_9ae25c7e:
    ...
    li "Я всё ближе к разгадке этого дела."
...
translate russian v12s7_lindsey2_4f3d01e6:
    ...
    li "Так и есть, несколько человек на борту рассказали мне, что Райн известный как Мистер Сторк не только упоминал об убийстве людей, но и хотел проверить, сможет ли он убить всех на борту, не будучи пойманным."
...
translate russian v12s7_lindsey2_22ca8425:
    ...
    u "Это объясняет, почему он не убил Имре или кого-либо еще на глазах у Имре."
...
translate russian v12s7_lindsey2_ce39d24d:
    ...
    li "Именно, потому что конечная цель Имре или миссис Сторк - завершит игру."
...
translate russian v12s7_lindsey2_cc274be4:
    ...
    u "Ты разговаривала со Сторками, может быть, попытаться заставить их разделиться?"
...
translate russian v12s7_lindsey2_5dd92cb3:
    ...
    li "Я думала об этом, но это слишком рискованно. Поскольку так легко убить, не будучи пойманным, а я - главный, кто заинтересован в поимке убийцы, я не могу рисковать быть убитым."

# game/v12/scene7.rpy:3026
translate russian v12s7_lindsey2_8c3c5fc1:

    # u "Well... sacrifice someone."
    u "Ну... пожертвуй кем-нибудь."
...
translate russian v12s7_lindsey2_575d2ad3:
    ...
    li "*Хихикает* Я думала об этом, но мне трудно выбрать, кто именно."
...
translate russian v12s7_lindsey2_af32fac9:
    ...
    li "О нет, Я точно бегу. Я говорю, что больше не напрягаюсь по этому поводу. Большинство девушек не против, чтобы я бегала, у меня есть план, как убедить остальных, так что сейчас я счастлива просто наслаждаться Европой."

# game/v12/scene7.rpy:3093
translate russian v12s7_lindsey2_764aa7de:

    # u "You never fail to amaze me Lindsey."
    u "Ты не перестаешь удивлять меня, Линдси."

# game/v12/scene7.rpy:3098
translate russian v12s7_lindsey2_ab1ca9ab:

    # li "I didn't become a detective by not being great."
    li "Я стал детективом не потому, что не была великой."
...
translate russian v12s7_lindsey2_daedf9db:
    ...
    li "Неизвестно, что он знает и чего не знает. Кажется, что мистер Ли знает все."
...
translate russian v12s7_lindsey2_79e72527:
    ...
    u "Ты не ошиблась. Вопрос, почему ты не подумала, что я убийца?"
...
translate russian v12s7_lindsey2_44721488:
    ...
    li "О, это нечестно, ты только что пытался задеть меня вопросом-ловушкой. *Щелкает*"
...
translate russian v12s7_lindsey2_16e920b0:
    ...
    u "Нет, всё в порядке, Чарли приучил меня к тому, что меня не любят."
...
translate russian v12s7_lindsey2_c7f6e755:
    ...
    li "Ну, я не испытываю к тебя неприязни... И это не имеет отношения к игре, и меня не выкинут за борт, так что я возвращаюсь к своему расследованию."

# game/v12/scene7.rpy:3173
translate russian v12s7_lindsey2_b1cc772c:

    # u "Ha, you do that."
    u "Ха, ты это сделаешь."
...
translate russian v12s7_lindsey_kill_c7ca4c4a:
    ...
    li "Может, мне стоит почаще слушать Чарли. *Хихикает*"
...
translate russian v12s7_charli_kill_901a5a2f:
    ...
    charli "Это заняло у тебя достаточно времени."
...
translate russian v12s7_charli_kill_2fef30e1:
    ...
    u "Не делай вид, что ты на самом деле знал, что это я. Ты просто счастлив, потому что тебе повезло, и теперь, похоже, ты был прав с самого начала."

# game/v12/scene7.rpy:3302
translate russian v12s7_charli_kill_df00c996:

    # charli "Think what you want to think."
    charli "Думай, что хочешь думать."

# game/v12/scene7.rpy:3324
translate russian v12s7_msrose1_6d6c9834:

    # ro "Hello there world-famous boxing champion."
    ro "Здравствуйте, всемирно известный чемпион по боксу."
...
translate russian v12s7_msrose1_db824684:
    ...
    ro "*Шокировано* Ты не знаешь, кто я?"
...
translate russian v12s7_msrose1_2998d9db:
    ...
    ro "Я всемирно известная и очень любимая Миа Скарлетт. Наиболее известна по роли в фильме \"Урок истории\"."
...
translate russian v12s7_msrose1_305f79f3:
    ...
    u "*Смеётся* \"Урок истории\"? О да, кажется, я видел вас в нескольких фильмах."
...
translate russian v12s7_msrose1_c34949b9:
    ...
    ro "В фильмах? И это все? Ты не помнишь, как встретил меня на рождественской битве?"
...
translate russian v12s7_msrose1_5b9e6357:
    ...
    ro "Обычно мне приходится настороженно относиться к людям, потому что большинство людей ассоциируют меня только с моей известностью и деньгами, а вы даже не смогли вспомнить, кто я такая. Вы настолько эгоцентричны?"
...
translate russian v12s7_msrose1_d5f5578d:
    ...
    ro "Итак, слышали ли вы о знаменитом убийце на борту корабля?"
...
translate russian v12s7_msrose1_3b3a0d6a:
    ...
    ro "Вы беспокоитесь о том, что вас могут убить на борту?"
...
translate russian v12s7_ms_rose_kill_62787ed4:
    ...
    ro "Он все время говорил, что не собирался выбирать тебя в качестве убийцы, но именно это он и сделал."
...
translate russian v12s7_ms_rose_kill_359cbf6e:
    ...
    ro "Я была уверена, что он выберет тебя, но он так ясно дал понять, что это будешь не ты. Я на самом деле шокирована."
...
translate russian v12s7_ms_rose_kill_9cce7f04:
    ...
    u "Я потрясен, что он не сказал тебе и заставил тебя играть роль."

# game/v12/scene7.rpy:3558
translate russian v12s7_ms_rose_kill_dccb9879:

    # ro "That was because I lost a bet. *Chuckles*"
    ro "Это было потому, что я проиграла пари. *Хихикает*"
...
translate russian v12s7_ms_rose_kill_f83c04fd:
    ...
    ro "Удачи, надеюсь, вы всех получите."
...
translate russian v12s7_penelope1_26427238:
    ...
    pe "Пожалуйста, сэр, мне сказали не разговаривать ни с кем из пассажиров."

# game/v12/scene7.rpy:3602
translate russian v12s7_penelope1_97a6265c:

    # u "I won't tell if you won't."
    u "Я не скажу, если ты не скажешь."
...
translate russian v12s7_penelope1_c0f10304:
    ...
    pe "Мне правда пора убираться, пока он не вернулся и не проверил меня. Я нахожусь на одном месте уже минут десять, потому что одно маленькое пятнышко не чиститься."

# game/v12/scene7.rpy:3612
translate russian v12s7_penelope1_c902f0e1:

    # u "Wait, is he actually making you clean the boat?"
    u "Подожди, он заставляет тебя убирать борт?"
...
translate russian v12s7_penelope1_91c49918:
    ...
    pe "Да, он сказал, почему бы не убить двух зайцев сразу, и сказал настоящему капитану, что я помогу с уборкой на борту."
...
translate russian v12s7_penelope1_9559a775:
    ...
    pe "Я могла бы наслаждаться приятной поездкой без лишних хлопот, если бы просто промолчала. Я сказала, что не могу дождаться, когда сяду на паром и расслаблюсь, и он меня услышал... и вот мы здесь."
...
translate russian v12s7_penelope1_bc1ce31e:
    ...
    u "Тебе и так тяжело убираться, так что я уверен, что убираться в образе - это отстой. Я оставлю тебя, чтобы не создавать тебе проблем и не давать еще больше работы."
...
translate russian v12s7_penelope1_858b3331:
    ...
    u "Эй, хочешь, я скажу мистеру Ли, чтобы он, смягчил тебе условия."
...
translate russian v12s7_penelope1_006e98c6:
    ...
    pe "Это мило, но я бы предпочла смелое лицо и пройти через это. Это лучше, чем 15 000 долларов."
...
translate russian v12s7_penelope1_c6f34594:
    ...
    u "Это правда, но я всё ещё хочу, чтобы ты смогла расслабиться. Я позабочусь о том, чтобы ты повеселилась в Париже."

# game/v12/scene7.rpy:3770
translate russian v12s7_penelope1_8116d263:

    # pe "Haha, I appreciate that."
    pe "Хаха, я благодарна тебе."
...
translate russian v12s7_penelope_kill_a415cf45:
    ...
    u "Никогда не видел, чтобы кто-то обнимал человека, который в него стреляет. *Хихикает*"
...
translate russian v12s7_penelope_kill_e0ceaaa2:
    ...
    pe "Ну, теперь я могу расслабиться. Мистер Ли сказал идти в коридор, если тебя убьют, так что я туда и пойду."

# game/v12/scene7.rpy:3872
translate russian v12s7_penelope_kill_296836e5:

    # u "Haha, you do that."
    u "Хаха, ты так и сделаешь."
...
translate russian v12s7_amber1_684aad24:
    ...
    am "О черт, это твой... почему ты так напряжён? Тебя это заводит?"
...
translate russian v12s7_amber1_e3e7d7eb:
    ...
    u "Когда меня прижимают к земле и садится на меня горячая цыпочка, я не думал, что мне понравится, но мне это нравится."
...
translate russian v12s7_amber1_4e65bff3:
    ...
    am "Хммм, полезно знать. Я запомню это на будущее."
...
translate russian v12s7_amber1_6b437b20:
    ...
    u "Когда меня прижимают к земле, это не то, что меня возбуждает, но ты вытаскиваешь мой член из кармана."

# game/v12/scene7.rpy:4030
translate russian v12s7_amber1_6611a4b8:

    # am "Guess you don't like it rough, too bad."
    am "Видимо, вам не нравится грубость, очень жаль."
...
translate russian v12s7_amber1_95df5998:
    ...
    am "Я ничего у вас не нашла, но мне не нравится ваш тон."
...
translate russian v12s7_amber1_cb7eab80:
    ...
    am "Я из службы безопасности, поймите правильно."
...
translate russian v12s7_amber1_f5de14ce:
    ...
    am "Теперь займитесь своими делами."
...
translate russian v12s7_amber_kill_48665a9a:
    ...
    am "Черт, надеюсь, я умру вот так. Это горячо."
...
translate russian v12s7_amber_kill_f6ee263c:
    ...
    am "Жаль, что я больше не могу трахаться с людьми. Ну что ж, иди убей несколько сучек."
...
translate russian v12s7_riley2_074f018e:
    ...
    u "Хорошо, тогда я не буду этого делать. *Chuckles* Почему ты не серьезна, ты была так взволнована этим."

# game/v12/scene7.rpy:4163
translate russian v12s7_riley2_90776645:

    # ri "Chris is just upsetting me a bit."
    ri "Крис немного расстраивает меня."
...
translate russian v12s7_riley2_a65fe06e:
    ...
    ri "Он совершенно не воспринимает свою роль всерьез, он буквально ничего не делает."

# game/v12/scene7.rpy:4178
translate russian v12s7_riley2_6368bd42:

    # u "Maybe this just isn't for everybody."
    u "Может, это просто не для всех."
...
translate russian v12s7_riley2_0d737778:
    ...
    ri "Я знаю, что это не для всех, но в этом есть нечто большее. По мере того, как я узнаю Криса и нахожусь рядом с ним, кажется, что он делает только то, что хочет делать."
...
translate russian v12s7_riley2_441f0750:
    ...
    ri "В большинстве случаев то, что он хочет сделать, правильно, но это все равно немного эгоистично, на мой взгляд."

# game/v12/scene7.rpy:4189
translate russian v12s7_riley2_1f7f91c4:

    # u "I didn't know you had beef with Chris."
    u "Я не знал, что у тебя есть претензии к Крису."
...
translate russian v12s7_riley2_8386c124:
    ...
    ri "Один из них - жестокий убийца, и если бы Крис отнесся к своей роли серьезно, было бы легче выяснить, кто именно. Он единственный повар."

# game/v12/scene7.rpy:4219
translate russian v12s7_riley2_0bb439a6:

    # u "How can the cook be helpful? *Chuckles*"
    u "Как повар может быть полезен? *Хихикает*"
...
translate russian v12s7_riley2_a50a5e99:
    ...
    ri "Я спросила мистера Ли, можем ли мы получить подсказки от людей в коридоре, и он сказал, что единственный человек, который может поговорить с людьми в коридоре за подсказками, - это повар Крис. Я поговорила с Крисом, но он отказался помочь."

# game/v12/scene7.rpy:4229
translate russian v12s7_riley2_d0dc5c9e:

    # u "Why'd he refuse?"
    u "Почему он отказался?"
...
translate russian v12s7_riley2_dc26b5f7:
    ...
    ri "Как я уже сказала, эгоист. Он просто держит свой телефон, пытаясь поймать сигнал, как будто он волшебным образом соединится, хотя это никому не помогло."
...
translate russian v12s7_riley2_71468422:
    ...
    u "Он пытается связаться с Себастьяном, он часто говорит по телефону, так что, что бы они не обсуждали, это должно быть важно. Его голова может быть в другом мире. Добавь к этому его проблемы с Норой."
...
translate russian v12s7_riley2_ac596a5d:
    ...
    ri "У него не было бы проблем с Норой, если бы он умел расставлять приоритеты."
...
translate russian v12s7_riley2_308a18f0:
    ...
    ri "Ты прав, не мое дело. Боже, я просто хочу уже узнать, кто убийца."
...
translate russian v12s7_riley2_485de75c:
    ...
    ri "Я вижу боксёра. Иди, выясни что-нибудь важное и хорошо доложи."

# game/v12/scene7.rpy:4279
translate russian v12s7_riley2_08e37a58:

    # u "I'm a successful and famous boxer, I don't take orders."
    u "Я успешный и известный боксер, я не подчиняюсь приказам."
...
translate russian v12s7_riley_kill2_84f0c9ce:
    ...
    ri "Как я могла не знать? Многие думали, что это Имре, так как он действовал мистеру Ли на нервы. *Хихикает*"
...
translate russian v12s7_riley_kill2_15839eb5:
    ...
    ri "Вау, ну, думаю, раз ты убил меня, я буду болеть за тебя. Так что удачи."
...
translate russian v12s7_riley2_amber_22405450:
    ...
    am "Я просто не готова ко всему этому, я думаю, что ты правда удивительная, но я просто не человек отношений."
...
translate russian v12s7_riley2_amber_b3432d46:
    ...
    ri "Мы не должны ни во что спешить, мы можем просто расслабиться."
...
translate russian v12s7_riley2_amber_4dc7afec:
    ...
    am "Я бы не хотела дать тебе ложную надежду или ввести в заблуждение."
...
translate russian v12s7_riley2_amber_5aa33551:
    ...
    am "Привет, не оставишь нас на минутку?"
...
translate russian v12s7_sam_cameron_ea6f58b5:
    ...
    sa "Я некогда знаменитая писательница, который потерпела неудачу, но мой предстоящий роман наконец-то перевернет мою карьеру."

# game/v12/scene7.rpy:4485
translate russian v12s7_sam_cameron_fcea5c79:

    # u "Nice nice, and what about Cameron?"
    u "Мило, мило, а как насчет Кэмерона?"
...
translate russian v12s7_sam_cameron_49dcb5d1:
    ...
    sa "У него нет роли, потому что он не участвует в поездке. Он просто преследует меня повсюду, помнишь?"
...
translate russian v12s7_sam_cameron_05fbcf5b:
    ...
    ca "Не говорите обо мне так, будто меня здесь нет. У меня действительно есть роль, я известный комик."

# game/v12/scene7.rpy:4505
translate russian v12s7_sam_cameron_bfb3c577:

    # u "You just decided that yourself? *Chuckles*"
    u "Ты сам так решил? *Хихикает*"
...
translate russian v12s7_sam_cameron_757ae1ff:
    ...
    ca "Это лучшее для меня, я самый смешной чувак на свете."
...
translate russian v12s7_sam_cameron_ab9f4758:
    ...
    ca "Потому что они не знают, где дом."
...
translate russian v12s7_sam_cameron_7e496ab6:
    ...
    sa "У него одни шутки про сирот, как будто он имеет что-то против сирот или что-то в этом роде."
...
translate russian v12s7_sam_cameron_5d88729b:
    ...
    ca "Не критикуй мое искусство, если ты его не понимаешь."
...
translate russian v12s7_sam_cameron_18675370:
    ...
    sa "Я ЗНАЮ, ЧТО ТЫ НЕ ПРОСТО ПЕРНУЛ НА МЕНЯ! ТЫ ОХУЕННО ПРОТИВНЫЙ!"
...
translate russian v12s7_sam_cameron_5d264323:
    ...
    ca "Не моя вина, что вы, ребята, не умеете шутить."
...
translate russian v12s7_sam_cameron_66209d91:
    ...
    u "Это была даже не шутка, ты просто повёл себя как придурок по отношению к своей сестре."
...
translate russian v12s7_sam_cameron_697e4977:
    ...
    ca "Что это, ты пытаешься быть её героем? То, что мистер Ли вручил тебе эти перчатки, не значит, что ты можешь со мной драться. Если только ты не хочешь это выяснить."
...
translate russian v12s7_sam2_1b53551c:
    ...
    u "Хочешь сосредоточиться на игре? В этом и смысл всего этого, я думаю... Заставить нас на время сосредоточиться на чем-то другом."

# game/v12/scene7.rpy:4717
translate russian v12s7_sam2_95d5275c:

    # u "I think this might help you think about something else..."
    u "Я думаю, это может помочь тебе подумать о чем-то другом..."
...
translate russian v12s7_sam2_db290bd6:
    ...
    sa "Ну, если бы я написала это убийство, я бы, наверное, выбрала Лорен на роль убийцы."

# game/v12/scene7.rpy:4760
translate russian v12s7_sam2_693b3993:

    # u "What? There's no way it'd be her."
    u "Что? Не может быть, чтобы это была она."
...
translate russian v12s7_sam2_c269c8bf:
    ...
    sa "Честно говоря, моя жизнь - отстой. Я взрослый человек, учусь в колледже, но вместо того, чтобы иметь друзей и жить той жизнью, которой я хочу жить..."
...
translate russian v12s7_sam2_709f74d2:
    ...
    sa "Брат душит меня буквально ни за что, кроме того, что ему нечем заняться. Я просто хочу быть самой собой."

# game/v12/scene7.rpy:4801
translate russian v12s7_sam2_0c02facf:

    # u "Get a restraining order."
    u "Получи запретительный судебный ордер."
...
translate russian v12s7_sam2_8eb27ca2:
    ...
    sa "Нет, но я не думаю, что мы бы поладили, она слишком мягкая."
...
translate russian v12s7_sam2_3a462014:
    ...
    u "Я бы не спешил с выводами, если кто-то добрый, это не значит, что он мягкий."

# game/v12/scene7.rpy:4836
translate russian v12s7_sam2_d8473a60:

    # sa "I've never seen or heard of her doing anything exciting."
    sa "Я никогда не видел и не слышал, чтобы она делала что-то захватывающее."
...
translate russian v12s7_sam2_9d2a66e8:
    ...
    u "Ну, ты не в ее кругу. Поверишь ли ты, если я скажу, что в первый же день в школе Райли, Имре, Лорен и я играли в \"Выпей или разденься\"?"

# game/v12/scene7.rpy:4846
translate russian v12s7_sam2_7bd31ab8:

    # sa "There's no way Lauren played that with you guys."
    sa "Лорен ни за что не стала бы играть с вами."
...
translate russian v12s7_sam2_17fb8c9b:
    ...
    u "Так и есть. Не суди о книге, пока не прочтёшь ее до конца."
...
translate russian v12s7_sam2_88397b80:
    ...
    sa "Хм, может, мне стоит попробовать поговорить с ней. А вот с кем я точно хочу пообщаться, так это с Эмбер."
...
translate russian v12s7_sam2_86e43d43:
    ...
    sa "После того, как я увидела, как она дерзко относится ко всей этой истории с безопасностью, я хочу познакомиться с ней поближе. Она похожа на меня, плюс я знаю, что они с Райли классные."

# game/v12/scene7.rpy:4862
translate russian v12s7_sam2_00c69058:

    # u "See, look at that, so many opportunities."
    u "Видишь, столько возможностей."
...
translate russian v12s7_sam2_3e0216ee:
    ...
    sa "Ну, мне нужно закончить свою книгу. Если я этого не сделаю, никто этого не сделает. До встречи [name] и спасибо за беседу."
...
translate russian v12s7_samantha_kill_b13a7cf3:
    ...
    sa "Он никак не мог выбрать тебя в качестве убийцы."
...
translate russian v12s7_samantha_kill_7cec54be:
    ...
    sa "Наслаждайтесь своим маленьким убийством, удачи."
...
translate russian v12s7_cameron2_f2ea4404:
    ...
    ca "Хорошо, скажите мне, в чем разница между сиротой и яблоком?"
...
translate russian v12s7_nora1_924d49c5:
    ...
    no "Пожалуйста, не приходите сюда с этим, я не пытаюсь играть прямо сейчас."
...
translate russian v12s7_nora1_fab35b3f:
    ...
    no "Это дурацкая игра, я только что имела дело с грёбаным ограблением прошлой ночью, и это кажется хорошей идеей?"

# game/v12/scene7.rpy:5154
translate russian v12s7_nora1_14257095:

    # u "Maybe it was planned prior, I'm sure it was."
    u "Может, игра была спланирована заранее, я уверен."
...
translate russian v12s7_nora1_e34a35d8:
    ...
    no "Ты уверен, что не хочешь обращать внимание на игру? Я не возьму на себя вину, если мистер Ли увидит, что мы говорим не по делу."
...
translate russian v12s7_nora1_a13b8313:
    ...
    no "*Хихикает* Все в порядке. По крайней мере, ты спросил. Приятно знать, что кому-то не всё равно."
...
translate russian v12s7_nora1_a7b4eda7:
    ...
    u "Нора, я знаю, это трудно понять, пока мы в поездке, но Крис заботится о тебе. Я знаю, что он очень занят, и это отстойно, что он не может..."
...
translate russian v12s7_nora1_5cefc7d7:
    ...
    no "Слушай, [name]. Всё, что ты говоришь, я уже слышала. Уже тысячи раз. И мне это осточертело. Почему никто не может понять это с моей точки зрения?"
...
translate russian v12s7_nora1_6fa7a4b0:
    ...
    no "Это всегда будет сводиться ко мне или к нему. Ты ведь знаешь это, да?"
...
translate russian v12s7_nora1_c8a8df20:
    ...
    no "В конце концов наступит момент, когда ты не сможешь играть за обе стороны. Либо он будет злиться, что ты разговариваешь со мной, либо я буду злиться, потому что ты разговариваешь с ним."

# game/v12/scene7.rpy:5306
translate russian v12s7_nora1_1d934acd:

    # no "It's going to happen, so what would be your choice?"
    no "Это должно произойти, так какой будет твой выбор?"

# game/v12/scene7.rpy:5312
translate russian v12s7_nora1_234d1ce1:

    # no "Nevermind, I already know you're going to say him."
    no "Неважно, я уже знаю, что ты скажешь."
...
translate russian v12s7_nora1_ec2e0f45:
    ...
    u "Звучит так, будто ты решила бросить Криса... Ты правда это сделаешь?"
...
translate russian v12s7_nora1_6c0fa2ce:
    ...
    no "Ничего, я получила свой ответ. Можешь идти. Спасибо за разговор."
...
translate russian v12s7_nora1_7746ccc4:
    ...
    no "Все в порядке. Я в порядке. Просто уходи."
...
translate russian v12s7_nora1_cd6b74c5:
    ...
    u "Ты всегда была для него важнее. И всегда будешь."
...
translate russian v12s7_nora1_0be92177:
    ...
    u "Это точно. С тобой гораздо веселее, и ты чертовски привлекательная. *Хихикает*"

# game/v12/scene7.rpy:5392
translate russian v12s7_nora1_803ae6cb:

    # no "Haha! You aren't wrong. *Chuckles*"
    no "Хаха! Ты не ошибся. *Хихикает*"
...
translate russian v12s7_nora1_39cc96a4:
    ...
    u "Ну, теперь, когда ты снова улыбаешься, я должен вернуться к игре. Поговорим позже?"

# game/v12/scene7.rpy:5402
translate russian v12s7_nora1_cdaeee23:

    # no "Yeah. And... thank you, really."
    no "Да. И... спасибо, правда."
...
translate russian v12s7_nora_kill_2f984d89:
    ...
    no "Я могу поцеловать тебя прямо сейчас."
...
translate russian v12s7_nora_kill_b2ca73ba:
    ...
    no "Чертовски вовремя! Спасибо [name]."
...
translate russian v12s7_chris1_96659a7c:
    ...
    ch "Я пытаюсь поймать сигнал. Я слышал, что если положить фольгу вокруг телефона под прямыми солнечными лучами, то можно поймать хотя бы единицу сигнала. Ты не знаешь, где я могу найти фольгу?"

# game/v12/scene7.rpy:5521
translate russian v12s7_chris1_bb22db95:

    # u "You need your phone that bad?"
    u "Тебе так нужен телефон?"
...
translate russian v12s7_chris1_a664f438:
    ...
    u "Ты с Себастьяном, должно быть, планируете что-то грандиозное."
...
translate russian v12s7_chris1_19e36037:
    ...
    ch "Дело не только в нас, происходящее - это серьезная традиция для обоих братств и то, что требует стопроцентного внимания и уважения."
...
translate russian v12s7_chris1_89fabfce:
    ...
    u "Ну, мужик, твой телефон здесь не работает."
...
translate russian v12s7_chris1_4438946a:
    ...
    ch "Тогда, я думаю, что мог бы компенсировать сон, который я не получил прошлой ночью."

# game/v12/scene7.rpy:5583
translate russian v12s7_chris1_301ef4e2:

    # u "Why didn't you get any sleep?"
    u "Почему ты не выспался?"
...
translate russian v12s7_chris1_b6625dd3:
    ...
    ch "Нора продолжала спорить, а когда я начал игнорировать её, она начала пилить меня. Так что я не спал всю ночь."
...
translate russian v12s7_chris1_7b51c588:
    ...
    ch "Да, но я не хочу говорить о ней или о том, что происходит. Честно говоря, я даже не знаю, что происходит."
...
translate russian v12s7_chris1_20ce181e:
    ...
    u "Что ж, тогда, пожалуй, я дам тебе отдохнуть."
...
translate russian v12s7_mrlee_adc31af4:
    ...
    u "Привет, вы любитель бокса? Если да, то видел ли ты мой последний бой?"

# game/v12/scene7.rpy:5751
translate russian v12s7_mrlee_6ed5384b:

    # lee "You can't talk to the Gamemaster."
    lee "Ты не можешь разговаривать с Гейм-мастером."
...
translate russian v12s7_josh1_d94cbe41:
    ...
    jo "Именно за такое неуважение чуть не убили сучку Рейчел Крэкен. Мы все знаем, что она убила своего мужа, возможно, скормила его леопардам. Отвратительно"

# game/v12/scene7.rpy:5825
translate russian v12s7_josh1_4478882a:

    # u "Killing her husband or feeding him to the leopards?"
    u "Убить мужа и скормить его леопардам?"
...
translate russian v12s7_josh1_beb74d52:
    ...
    jo "Никому не было дела до этого морщинистого старика, жаль, что леопардам пришлось съесть его покрытую коркой задницу."

# game/v12/scene7.rpy:5839
translate russian v12s7_josh1_c7f6f5c7:

    # u "*Laughs* You really care about your cats, huh?"
    u "Ты правда заботишься о своих кошках, да?"
...
translate russian v12s7_josh1_5aae522c:
    ...
    jo "Кошки? КОШКИ!!!? Ты относишься к ним неуважительно! Они - вершина всех кошачьих. Леопард - достойное существо, созданное Богом. Также... *шепотом* Не смейся надо мной, черт возьми."

# game/v12/scene7.rpy:5849
translate russian v12s7_josh1_8903e7ae:

    # u "*Laughs* Have you seen yourself?"
    u "*Смеется* Ты видел себя?"
...
translate russian v12s7_josh1_d4766f09:
    ...
    u "Джош, ты делаешь лучшую актерскую работу из всех здесь присутствующих. *Хихикает*"
...
translate russian v12s7_josh1_60a26d32:
    ...
    jo "Не проявляй ко мне неуважения, обращайтесь ко мне правильно. Я - Повелитель Леопардов."

# game/v12/scene7.rpy:5866
translate russian v12s7_josh1_1db979da:

    # u "Getting pretty deep into this, huh?"
    u "Довольно глубоко в это влез, да?"
...
translate russian v12s7_josh1_47abc3e7:
    ...
    jo "Послушайте, понятия не имею, о чем вы говорите, но как только мы прибудем в Париж, я с удовольствием отведу вас в мой парижский зоопарк, если вы захотите познакомиться с моими леопардами."

# game/v12/scene7.rpy:5876
translate russian v12s7_josh1_fe428c13:

    # u "Umm yeah... I'll keep that in mind."
    u "Да... Я буду иметь это в виду."
...
translate russian v12s7_josh1_8a005d06:
    ...
    jo "Если вы это сделаете, то не будет более величественного зрелища, чем вид могучего леопарда."
...
translate russian v12s7_josh2_5cefa357:
    ...
    jo "У меня есть небольшое предложение."
...
translate russian v12s7_josh2_e039e921:
    ...
    jo "Ну, теперь самое время подумать. У меня есть великолепный мальчик-леопард, который нуждается в заботе отдельного дома."

# game/v12/scene7.rpy:5978
translate russian v12s7_josh2_acb55547:

    # u "Why can't he be with the rest?"
    u "Почему он не может быть с остальными?"
...
translate russian v12s7_josh2_1099ff46:
    ...
    jo "Видите ли, над ним издевались соседние обезьяны, и они оторвали ему хвост."

# game/v12/scene7.rpy:5996
translate russian v12s7_josh2_00556904:

    # u "*Laughs* They ripped off your baby leopard's tail?"
    u "*Смеется* Они оторвали хвост твоему детенышу леопарда?"
...
translate russian v12s7_josh2_357e1648:
    ...
    jo "Это не повод для смеха, мальчик, будущий король страны леопардов остался без хвоста, а ты так себя ведешь. Позор тебе, позор!"

# game/v12/scene7.rpy:6014
translate russian v12s7_josh2_f452e184:

    # u "I didn't know it was that serious, sorry dude."
    u "Я не знал, что все так серьезно, извини, чувак."
...
translate russian v12s7_josh2_8c640a70:
    ...
    jo "Ты не знал, что это... Кто ты вообще такой? Ты не тот человек, кем я тебя считал. Я ни за что не осмелюсь позволить тебе ухаживать за королем страны."

# game/v12/scene7.rpy:6032
translate russian v12s7_josh2_90be1788:

    # u "Oh wow, that sucks... I really wanted to."
    u "Ух ты, это отстой... Я правда хотел."
...
translate russian v12s7_josh2_567a56f8:
    ...
    jo "Надо было думать об этом, прежде чем сыпать оскорблениями. Доброго дня, сэр."
...
translate russian v12s7_josh_kill_704101bb:
    ...
    jo "Что? Нет, пожалуйста, не убивай меня. Мне было очень весело."
...
translate russian v12s7_josh_kill_57474d13:
    ...
    jo "Я перестану вести себя как Повелитель Леопардов."
...
translate russian v12s7_josh_kill_1fb18b13:
    ...
    u "Не тогда, а в роли трупа в коридоре."
...
translate russian v12s7_emily1_c224e1f2:
    ...
    em "Хммм, я вижу, когда в одиночестве и только в одиночестве у пассажиров будут украдены жизни, которую они всегда знали."

# game/v12/scene7.rpy:6140
translate russian v12s7_emily1_d573bead:

    # u "Talking to yourself?"
    u "Разговариваешь сама с собой?"
...
translate russian v12s7_emily1_106b8351:
    ...
    em "Я экстрасенс, я наслаждаюсь отдыхом, разговаривая с собой, чтобы меня НЕ беспокоили."

# game/v12/scene7.rpy:6150
translate russian v12s7_emily1_43b212fb:

    # u "I got stuck as the boxer."
    u "Я застрял в роли боксера."
...
translate russian v12s7_emily1_a53bbe02:
    ...
    em "Мне, в общем-то, все равно, но я только что довольно ясно увидела, как ты уходишь."

# game/v12/scene7.rpy:6160
translate russian v12s7_emily1_6f17c432:

    # u "I can take a hint."
    u "Я могу понять намек."
...
translate russian v12s7_emily2_9fd2357e:
    ...
    em "Боже мой, ты можешь перестать использовать игру как предлог, чтобы поговорить со мной?"

# game/v12/scene7.rpy:6194
translate russian v12s7_emily2_07dc06c4:

    # u "I'm just trying to... *Sighs* Nevermind."
    u "Я просто пытаюсь... *Вздох* Неважно."
...
translate russian strings:
    ...
    new "Это очень больно."

    # game/v12/scene7.rpy:550
    old "Didn't even feel it"
    new "Даже не почувствовал"
    ...
    new "Скажи Райану, чтобы остыл."

    # game/v12/scene7.rpy:2807
    old "Ryan is suspicious"
    new "Подозреваю Райна"
