...
translate russian v12_party_wake_up_712a541a:
    ...
    no "Ой! Имре, ты похож на странного енота... Иди сюда, малыш..."
...
translate russian v12_party_wake_up_ce0df527:
    ...
    au "Кто-то очень мил сегодня утром."
...
translate russian v12_party_wake_up_c5fc922d:
    ...
    no "Хаха, это был комплимент. Не за что. Сколько сейчас времени?"
...
translate russian v12_party_wake_up_997df18d:
    ...
    no "Тогда ты можешь сходить со мной."
...
translate russian v12_party_wake_up_b2d3a4dc:
    ...
    li "Как Хлоя?! Что бы ты сделала по-другому? Я давала тебе идеи и говорила с тобой обо всём этом раньше, но ты отмахнулась от меня. И других девушек ты тоже не слушаешь."
...
translate russian v12_party_wake_up_cee82729:
    ...
    cl "Мы не можем измениться в одночасье. Всё требует времени!"
...
translate russian v12_party_wake_up_275671a7:
    ...
    li "Это твоя проблема, Хлоя. Ты точно знаешь, что и как делать, мы тебе говорили. Много раз. Но ты ни черта не делаешь..."

# game/v12/scene19.rpy:259
translate russian v12_party_wake_up_2aa52f23:

    # cl "Ha! You don't think I'm trying?!"
    cl "Ха! Ты думаешь, я не пытаюсь?!"
...
translate russian v12_party_wake_up_f9701b1c:
    ...
    li "Прости, Хлоя... Но нет. У нас есть возможность спасти это женское общество, и раз ты не хочешь, то это сделаю я!"
...
translate russian v12_party_wake_up_fe5299f0:
    ...
    cl "Это не поможет, Линдси. Если что, это только разделит сестринство."
...
translate russian v12_party_wake_up_e15bd30d:
    ...
    li "Ты так слепа к тому факту, что проблема в тебе, и не хочешь этого признавать."

# game/v12/scene19.rpy:279
translate russian v12_party_wake_up_bf2c275c:

    # cl "I thought we were friends, Lindsey."
    cl "Я думала, мы друзья, Линдси."
...
translate russian v12_party_wake_up_9674e2d9:
    ...
    li "Да, но это совсем другое дело. Я никогда не хотела, чтобы это разрушило нашу дружбу."
...
translate russian v12_party_wake_up_06b50048:
    ...
    cl "И всё же ты говоришь и планируешь за моей спиной..."
...
translate russian v12_party_wake_up_827ceb9b:
    ...
    li "За последние несколько недель я столько раз обращалась к тебе, Хлоя. Открываюсь тебе и всеми своими решениями в надежде, что ты будешь хоть немного открыта к тому, чего хотим мы, девочки."

# game/v12/scene19.rpy:295
translate russian v12_party_wake_up_3240a31a:

    # li "And you just refuse to hear any advice."
    li "А ты отказываешься слушать любые советы."
...
translate russian v12_party_wake_up_585ad0ca:
    ...
    cl "Мы сейчас в Европе, и что мне теперь делать?"
...
translate russian v12_party_wake_up_f8ad63be:
    ...
    li "Пожалуйста, не оправдывайся... Я знаю, что ты не собиралась следовать моим советам. Каждый раз, когда я предлагала что-то, ты придумывала какую-нибудь причину, чтобы возразить."
...
translate russian v12_party_wake_up_6141847b:
    ...
    cl "Вау, ты правда этого не понимаешь... Когда всё взорвется, знай, что ты это начала!"
...
translate russian v12_party_wake_up_2d074143:
    ...
    u "(Возвращение в кампус будет интересным...)!"
...
translate russian strings:
    ...
    new "Не круто, Эмбер... Не круто... ;)"

    # game/v12/scene19.rpy:207
    old "It's just a prank bro!"
    new "Это просто розыгрыш, бро!"
