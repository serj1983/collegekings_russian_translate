...
translate russian v12_follow_chris_0ca7912d:
    ...
    u "Крис, что, черт возьми, с тобой сейчас происходит?"
...
translate russian v12_follow_chris_3bfc2273:
    ...
    ch "Что значит что происходит?! Ты что, не видел, что я сделал?! Я только что потянул за последнюю соломинку. Она не простит меня после такого."
...
translate russian v12_follow_chris_2b93ea74:
    ...
    u "Вы, ребята, и так уже устроили достаточно шумную сцену. Давай отвезем тебя в больницу, чтобы проверить твоё запястье."
...
translate russian v12_follow_chris_e6019275:
    ...
    ch "Вот и все, на этот раз я правда всё испортил. Я не должен был позволить этому зайти так далеко..."
...
translate russian v12_follow_chris_6c28b820:
    ...
    u "Не буду врать, чувак, это было действительно плохо. Я почти почувствовал необходимость вмешаться."

# game/v12/scene26a.rpy:73
translate russian v12_follow_chris_5346266b:

    # ch "She just... *Sighs*"
    ch "Она просто... *Вздыхает*"
...
translate russian v12_follow_chris_4a538237:
    ...
    u "Что заставило тебя взорваться? Ты, блядь, толкнул её, Крис..."
...
translate russian v12_follow_chris_60dbd3cb:
    ...
    ch "И она была готова высказать это вслух, зная, что я буду чувствовать.  Ей явно наплевать на то, что я чувствую."
...
translate russian v12_follow_chris_8bc36da8:
    ...
    u "Мне кажется, что она обращалась с тобой так, как, по её мнению, ты обращался с ней. На самом деле, я уверен, что именно это и происходит."
...
translate russian v12_follow_chris_329bcc25:
    ...
    u "Нора верно подметила. Все в этой поездке знают, что она умоляла тебя провести с ней немного времени."
...
translate russian v12_follow_chris_d2a29f19:
    ...
    u "Похоже, у тебя наконец-то появилось свободное время и ты выбрал парней, а не её. Похоже, ты сильно облажался, учитывая, что ты был так занят в последнее время, что заставило тебя многое пропустить."
...
translate russian v12_follow_chris_f7334dcd:
    ...
    u "Я имею в виду, искренне, Крис? Ты буквально бросил ее у алтаря на днях. *Хихикает*"
...
translate russian v12_follow_chris_187cf93d:
    ...
    u "Возможно, это было не по-настоящему, но всё же... Думаю, все чувствовали себя немного неловко из-за того, что ты сделал."
...
translate russian v12_follow_chris_c6d69e9f:
    ...
    u "Крис, я знаю, что ты хочешь, чтобы все видели это с твоей точки зрения, но, возможно, на секунду тебе нужно попытаться увидеть это с её."
...
translate russian v12_follow_chris_bb74bdfc:
    ...
    ch "Бро, я серьезно устал говорить об этом. Ты бесишь меня ещё больше."

# game/v12/scene26a.rpy:202
translate russian v12_follow_chris_8073384a:

    # ch "You don't need to follow me. I insist."
    ch "Дальше, тебе не нужно идти со мной. Я настаиваю."
...
translate russian v12_follow_chris_2d32c103:
    ...
    driver "Не волнуйтесь, я могу отвезти вас обратно."
...
translate russian v12_follow_chris_46b6c062:
    ...
    u "Ты прав, Крис. Она зашла слишком далеко, но... Я не знаю, что ты можешь сделать, чтобы заставить её понять."
...
translate russian v12_follow_chris_e7d767c1:
    ...
    u "Однако я бы пока не стал просто сдаваться в этой ситуации. Если бы я был на вашем месте, я имею в виду..."
...
translate russian v12_follow_chris_2a5fe815:
    ...
    u "Конечно, ты только что потерпел серьезную неудачу. Но это не значит, что всё кончено. Ты всегда можешь сделать что-то еще."
...
translate russian v12_follow_chris_ba96d113:
    ...
    ch "Я рад, что ты поддержал меня, чувствую, что я один в этой ситуации. Вот почему я хотел пойти с ребятами..."
...
translate russian v12_follow_chris_8cee4a26:
    ...
    ch "Я надеялся, что смогу получить совет по поводу ситуации с Норой, но, очевидно, это уже не имеет значения."

# game/v12/scene26a.rpy:247
translate russian v12_follow_chris_ddfacc36:

    # u "How'd she find out you were going out with guys?"
    u "Как она узнала, что ты встречаешься с парнями?"
...
translate russian v12_follow_chris_045a003e:
    ...
    u "Не буду врать, ты должен был знать, что она разозлится на тебя. Особенно когда она с самого начала просила потусоваться."
...
translate russian v12_follow_chris_80b37da8:
    ...
    ch "Да, я знаю. Честно говоря, я не подумал об этом. Поскольку я планировал сделать что-то для нас, мне это просто не пришло в голову."

# game/v12/scene26a.rpy:277
translate russian v12_follow_chris_3b27a35f:

    # u "Yeah man, I get it."
    u "Да, мужик, я понимаю."
...
translate russian v12_follow_chris_44dc720d:
    ...
    ch "Болит чертовски сильно... Уверен, что это просто растяжение, я много дрался, так что знаю, что такое растяжение запястья. *Хихикает*"
...
translate russian v12_follow_chris_9305b7b4:
    ...
    u "*Хихикает* Уверен, что да. Не думаю, что когда-либо видел тебя настолько сумасшедшим. Думаю, на минуту я увидел в тебе Грейсона."
...
translate russian v12_follow_chris_4b99aa71:
    ...
    ch "Я не люблю так злиться, но я бы солгал, если бы сказал, что у меня не было таких моментов."

# game/v12/scene26a.rpy:345
translate russian v12_follow_chris_4a16997a:

    # u "We all have our downfalls, no one's perfect."
    u "Мы все терпим неудачи, никто не идеален."
