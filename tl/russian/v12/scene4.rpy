...
translate russian v12_roomate_talk_a270b5dc:
    ...
    cl "Что, ты беспокоился обо мне? *Хихикает*"
...
translate russian v12_roomate_talk_ebdfd07a:
    ...
    u "Да, вроде того... Не то, чтобы мы не были в центре ограбления или чего-то такого."
...
translate russian v12_roomate_talk_21c5ffec:
    ...
    u "Ха-ха, нет, мне просто было любопытно. Я знаю, что ты можешь позаботиться о себе."
...
translate russian v12_roomate_talk_ec9c96f2:
    ...
    cl "*Хихикает* Я просто хотела выпить, чтобы успокоить нервы, поэтому спустилась в бар."
...
translate russian v12_roomate_talk_7d16e1de:
    ...
    cl "Не принимай это за грубость, но ему повезло, что он стащил сумку Норы. Если бы он взял сумку у Эмбер или Кэмерон... он бы не далеко ушёл. *Хихикает*"
...
translate russian v12_roomate_talk_e2ad9d88:
    ...
    cl "Хм, может быть, я ошибалась... Извини. Не знала, что мой сосед по комнате был непревзойденным телохранителем."
...
translate russian v12_roomate_talk_e2680fa8:
    ...
    cl "В основном, что он стал достаточно сильным, чтобы справиться с Грейсоном."
...
translate russian v12_roomate_talk_a92af3bc:
    ...
    u "*Смеется* Удачи ему. Не думаю, что он сможет сделать это в ближайшее время."

# game/v12/scene4.rpy:144
translate russian v12_roomate_talk_ad6517d9:

    # cl "You don't think Ryan's a good fighter?"
    cl "Ты не думаешь, что Райан хороший боец?"
...
translate russian v12_roomate_talk_de1e605f:
    ...
    cl "Недостаточно, ха-ха. Не знаю почему, но в последнее время у меня так часто бывает икота."
...
translate russian v12_roomate_talk_4c47d341:
    ...
    cl "Давай ляжем спать. Если я сейчас не лягу, то не встану вовремя, чтобы уйти."
...
translate russian v12_roomate_talk_9957587c:
    ...
    u "Кто-то выглядит очень уютно в моей постели"
...
translate russian v12_roomate_talk_f26f97e3:
    ...
    cl "Теперь это наша кровать, глупышка... Выключи свет, чтобы мы могли лечь спать. И поторопись! Мне холодно. *Хихикает*"

# game/v12/scene4.rpy:245
translate russian v12_roomate_talk_73a3999a:

    # u "*Chuckles* (What is this girl doing to me?)"
    u "*Хихикает* (Что эта девушка делает со мной?)"
...
translate russian v12_roomate_talk_7dee940a:
    ...
    cl "Не мог бы ты выключить свет, пожалуйста? Спасибо. *Хихикает*"
...
translate russian v12_roomate_talk_db00970b:
    ...
    ri "*Хихикает* Ты что, дежурный по коридору?"
...
translate russian v12_roomate_talk_2bf4e1e6:
    ...
    u "Что? *Смеется* Мне просто было любопытно, куда ты пошла после всего, что случилось. Я думал, ты будешь в комнате."

# game/v12/scene4.rpy:302
translate russian v12_roomate_talk_21d66c26:

    # ri "I was out with Lindsey actually."
    ri "Вообще-то я гуляла с Линдси."
...
translate russian v12_roomate_talk_8eceb744:
    ...
    ri "У кого-то много вопросов. *Хихикает* Ты хотел, чтобы я была здесь с тобой или что-то в этом роде?"

# game/v12/scene4.rpy:320
translate russian v12_roomate_talk_0e191630:

    # u "A little bit, it is a lot nicer when you're around."
    u "Немного, но гораздо приятнее, когда ты рядом."
...
translate russian v12_roomate_talk_e32d807e:
    ...
    ri "Ой. Думаю, я не могу расстраиваться из-за того, что ты скучаешь по мне. *Хихикает*"
...
translate russian v12_roomate_talk_b08b1b3a:
    ...
    u "Ха-ха, не совсем. Я наслаждался одиночеством. Я просто хотел знать, что ты делаешь, чтобы я знал, как занять тебя в следующий раз, когда я захочу побыть один."

# game/v12/scene4.rpy:337
translate russian v12_roomate_talk_7a2295b6:

    # ri "Uhh, rude. *Chuckles*"
    ri "Ах, как это грубо. *Хихикает*"
...
translate russian v12_roomate_talk_30e97016:
    ...
    u "Я думал, ты будешь немного более напряжена после того, что только что произошло."
...
translate russian v12_roomate_talk_673070a9:
    ...
    ri "Почему? Меня же не ограбили, это бы меня точно напугало."
...
translate russian v12_roomate_talk_c9411d50:
    ...
    ri "К тому же, ты с ним справился. Если уж на то пошло, то это он должен быть в стрессе."
...
translate russian v12_roomate_talk_59c367e1:
    ...
    ri "Нору ограбили, поэтому если кто и испытывает стресс, так это она."
...
translate russian v12_roomate_talk_51180891:
    ...
    ri "О, неважно. *Хихикает* Я сказала Линдси, что не решалась вступить в женское общество, потому что моя семья была против, но в последнее время я подумываю об этом."
...
translate russian v12_roomate_talk_f5050366:
    ...
    ri "Она спросила меня, что я думаю о Чикс, и я была честна. Я думаю, что у них много драмы."

# game/v12/scene4.rpy:395
translate russian v12_roomate_talk_0199a0c7:

    # u "So is there another one you're looking at?"
    u "Так есть еще одна, на которую ты смотришь?"
...
translate russian v12_roomate_talk_e12272af:
    ...
    ri "Ну, так оно и было, но потом Линдси согласилась, что было много драмы, но пообещала мне, что она планирует баллотироваться в президенты против Хлои."
...
translate russian v12_roomate_talk_0093fb65:
    ...
    ri "Что ж, я рада, что ты мне сказал, потому что я этого не знала. *Хихикает*"
...
translate russian v12_roomate_talk_cf218723:
    ...
    ri "Да... У нее есть целый слоган для предвыборной кампании и все такое."
...
translate russian v12_roomate_talk_9a4d80bd:
    ...
    u "Вау, это очень важные новости. Я немного волнуюсь, ожидая увидеть, как все это будет происходить."
...
translate russian v12_roomate_talk_6200c2dc:
    ...
    ri "Я тоже. Она не просила меня никому не рассказывать, но на всякий случай нам, наверное, следует держать это при себе."
...
translate russian v12_roomate_talk_c680ec46:
    ...
    u "Конечно, я ни во что из этого не вмешиваюсь.  *Хихикает*"
...
translate russian v12_roomate_talk_3eaf4f42:
    ...
    u "(Все спят в одной комнате, без учителей?) Это довольно весело."
