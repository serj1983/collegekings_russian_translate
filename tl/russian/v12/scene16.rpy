...
translate russian v12_valentine_eafdec51:
    ...
    u "Дом, милый дом... *Смеется* Как себя чувствуешь?"
...
translate russian v12_valentine_e86d9dac:
    ...
    ri "Спасибо. Чувствую себя хорошо, вообще-то. Две подсказки, следующая остановка Амстердам."
...
translate russian v12_valentine_167da8d3:
    ...
    lee "Райли, что-то задержало вас обоих? Я думал, вы вернетесь раньше."

# game/v12/scene16.rpy:38
translate russian v12_valentine_98e7a193:

    # ri "Sorry, we were doing the second riddle."
    ri "Извините, мы отгадывали вторую загадку."
...
translate russian v12_valentine_2615c92f:
    ...
    lee "О, не стоит извиняться за это. Я рад видеть, что вы, ребята, так продуктивно охотитесь!"
...
translate russian v12_valentine_29c8ace7:
    ...
    ri "Конечно. Кстати, не хотелось бы пропускать следующее мероприятие, но я немного подвернула лодыжку, пока мы охотились, и надеялась немного отдохнуть..."
...
translate russian v12_valentine_f4cdac5e:
    ...
    lee "Конечно, да! Мисс Роуз будет здесь, в отеле, так что если вам что-то понадобится, обращайтесь к ней."
...
translate russian v12_valentine_63ee26cf:
    ...
    lee "Я заметил, что здесь не все, но это нормально. Я втайне надеялся, что на этот раз народу будет поменьше, чтобы те, кто пришёл, смогли насладиться этим ещё больше."

# game/v12/scene16.rpy:83
translate russian v12_valentine_281f0540:

    # li "What exactly are we doing?"
    li "Что конкретно мы будем делать?"
...
translate russian v12_valentine_4536cc56:
    ...
    lee "Ну... Как я уже сказал, сегодня мы узнаем о любви. Как же без этого в Городе Любви?"
...
translate russian v12_valentine_031d3a4f:
    ...
    lee "Здесь неподалеку есть церковь, и епископ был достаточно любезен, чтобы ознакомить вас, студентов, истории о Валентине. Я могу ознакомить вас сам, но я уверен, что это будет гораздо более приятным опытом."

# game/v12/scene16.rpy:98
translate russian v12_valentine_d5702d98:

    # li "This is kind of exciting... *Chuckles*"
    li "Это довольно волнующе... *Хихикает*"
...
translate russian v12_valentine_814f5f68:
    ...
    lee "Это так. На самом деле, церковь, в которую мы идем, была главной церковью Святого Валентина, когда он покинул Италию. Круто, правда?"
...
translate russian v12_valentine_694d3790:
    ...
    lee "Итак, если все готовы. Вы, ребята, знаете порядок, шаттлы снаружи."
...
translate russian v12_valentine_1b4dc306:
    ...
    bishop "Мистер Ли! Это, должно быть, ваши студенты, очень приятно познакомиться с вами. Вам сказал учитель, что вы будете изучать сегодня?"
...
translate russian v12_valentine_34c9f91f:
    ...
    bishop "Очень хорошо. Пожалуйста, следуйте за мной и займите место здесь, впереди."
...
translate russian v12_valentine_5789e68e:
    ...
    bishop "*Улыбается* Обычно так бывает с большинством студентов. Из-за того, что большинство праздников имеют религиозные корни, в школах редко учат учеников смыслу Дня Святого Валентина."
...
translate russian v12_valentine_ad35984f:
    ...
    bishop "Но сегодня я буду делать именно это. Кто-нибудь из вас слышал о Святом Валентине?"
...
translate russian v12_valentine_3bb72112:
    ...
    bishop "Здесь нет глупых вопросов, нет плохих догадок. Мы приветствуем всех, мистер Ли."
...
translate russian v12_valentine_321e9c39:
    ...
    bishop "Для вас, молодой человек, тот, о ком вы сказали, - это вымышленный персонаж по имени Купидон, который обычно ассоциируется с Днем святого Валентина, поскольку является Римским богом любви."
...
translate russian v12_valentine_5862b772:
    ...
    bishop "Еще одна распространенная ошибка. Купидон - римский бог любви, а в греческой мифологии он сын Афродиты, которая в греческой мифологии является богиней красоты и любви."
...
translate russian v12_valentine_41c83b3a:
    ...
    bishop "Две тысячи лет назад у римлян была самая сильная армия в мире. Они были настолько сильны, что завоевали почти всю Европу, часть Азии и Африки."

# game/v12/scene16.rpy:263
translate russian v12_valentine_b9753934:

    # charli "Around the time Jesus was killed?"
    charli "Примерно в то время, когда Иисус был убит?"
...
translate russian v12_valentine_d6319c29:
    ...
    bishop "Правильно. Через некоторое время они стали очень богатеть, а вместе с богатством пришла и лень. Жизнь в армии была суровой, поэтому многие солдаты тосковали по домашнему уюту... И самое главное - женитьбы."
...
translate russian v12_valentine_67aa57bd:
    ...
    bishop "К сожалению, император в то время стал беспокоиться о том, что его армия слабеет, и решил запретить солдатам жениться."
...
translate russian v12_valentine_e5d91b00:
    ...
    li "Как он мог это сделать? Разве не было какого-то конгресса или чего-то в этом роде?"
...
translate russian v12_valentine_441ba8b1:
    ...
    bishop "Ахх, молодёжь. Итак, в то время многие римляне были христианами, и был у них епископский лидер по имени Валентин."

# game/v12/scene16.rpy:343
translate russian v12_valentine_468786d4:

    # no "You hold the same position that Valentine had."
    no "Вы занимаете ту же позицию, что и Валентин."
...
translate russian v12_valentine_bcd5268b:
    ...
    bishop "Именно так. Как и Валентин, я тоже считаю, что если мужчина и женщина любят друг друга, они оба должны жениться."
...
translate russian v12_valentine_b5d3929d:
    ...
    bishop "Валентин пошел против закона императора и разрешил солдатам тайно венчаться в его церкви."
...
translate russian v12_valentine_2b3498d7:
    ...
    lee "Я уверен, что он проводил церемонии ночью, глубоко в лесу, чтобы не вызывать подозрений."

# game/v12/scene16.rpy:359
translate russian v12_valentine_f9c8cee0:

    # bishop "And, do you have a source for that information?"
    bishop "Откуда у вас этот источник информации?"
...
translate russian v12_valentine_bdc9bce2:
    ...
    lee "Я хотел быть так же информированным в этом вопросе, как и вы, поэтому провел множество исследований во время моего пребывания в Европе."
...
translate russian v12_valentine_40786f70:
    ...
    bishop "Не сочтите за неуважение, но я сомневаюсь, что ваши однодневные исследования могут компенсировать десятилетия изучения древнего текста."
...
translate russian v12_valentine_5cf1e8c4:
    ...
    bishop "В тюрьме, перед казнью, слепая дочь тюремщика приносила ему еду, и из этого вытекало много разговоров. Из этих многочисленных разговоров они влюбились друг в друга."
...
translate russian v12_valentine_64b36ec2:
    ...
    bishop "Казнь Валентина была назначена на 14 февраля, и в свой последний день он написал своей возлюбленной письмо и подписал его: \"От твоего Валентина.\"."

# game/v12/scene16.rpy:412
translate russian v12_valentine_025ea3b9:

    # no "That is so sweet but so sad."
    no "Это так мило, но так грустно."
...
translate russian v12_valentine_4c46d298:
    ...
    bishop "Возлюбленная Валентина получила письмо и перед казнью умоляла своего отца, тюремщика, помочь Валентину бежать."
...
translate russian v12_valentine_564dc7c3:
    ...
    bishop "Её отец так и поступил, и Валентин прибыл на территорию современного Парижа."
...
translate russian v12_valentine_095ca792:
    ...
    lee "Он не сбежал, его казнили. Именно это сделало историю трагичной. Ни в одном из известных исследований не упоминается, что он бежал."

# game/v12/scene16.rpy:428
translate russian v12_valentine_a95776f1:

    # bishop "Clarification, none of your known research."
    bishop "Уточнение, ни одно из известных вам исследований."

# game/v12/scene16.rpy:433
translate russian v12_valentine_f12d9273:

    # lee "I'd like to see what artifacts prove his escape."
    lee "Я бы хотел увидеть, какие артефакты доказывают его побег."
...
translate russian v12_valentine_51ee55db:
    ...
    bishop "Мистер Ли, мы все профессионалы в том, чему посвятили свою жизнь."
...
translate russian v12_valentine_a1208f92:
    ...
    bishop "Ваше знание истории в общем смысле - это то, что я никогда не попытался бы оспорить. Я был бы признателен за такое же уважение к моей специализации."
...
translate russian v12_valentine_c8fff498:
    ...
    lee "Я просто не хочу, чтобы моим ученикам давали ложную информацию."
...
translate russian v12_valentine_8b61c4cb:
    ...
    imre "Мистер Ли, \"если вы хотите вести себя как ребенок, я буду обращаться с вами как с ребенком... помните, это церковь.\""
...
translate russian v12_valentine_041b55c7:
    ...
    charli "Даже я должен признать, что это было иронически смешно."
...
translate russian v12_valentine_72f4a585:
    ...
    bishop "Продолжим, студенты, Валентин посвятил свою жизнь тому, чтобы другие могли жить в любви, и в конце концов именно любовь спасла его."
...
translate russian v12_valentine_3a7a8e1f:
    ...
    bishop "Прекрасно, теперь кто-нибудь из вас..."
...
translate russian v12_valentine_442fb507:
    ...
    ch "Я ждал этого звонка, мне очень жаль. Я должен ответить."
...
translate russian v12_valentine_ae25db16:
    ...
    bishop "Существует стандартный набор клятв, разработанный церковью, но участники всегда могут произнести свои собственные клятвы."
...
translate russian v12_valentine_4c1aca09:
    ...
    lee "Я хотел бы увидеть некоторую оригинальность, поэтому студенты должны сделать свои собственные."
...
translate russian v12_valentine_8f30ee4d:
    ...
    bishop "Да будет так. Мы уже немного поторопились с церемонией, но я уверен, что большинство из вас видели свадьбу, так что я полагаю, что вы понимаете суть."
...
translate russian v12_valentine_c325784d:
    ...
    u "*Шепот* Я знаю, это тебя беспокоит, но постарайся расслабиться, хорошо? Беспокойся о том, что перед тобой, а не о том, что в коридоре."

# game/v12/scene16.rpy:642
translate russian v12_valentine_5a93da74:

    # bishop "What's your name, miss?"
    bishop "Как вас зовут, мисс?"
...
translate russian v12_valentine_5b778504:
    ...
    bishop "Очень хорошо, сначала дама. Мисс Нора, просто говорите от чистого сердца. Не думайте слишком много."
...
translate russian v12_valentine_ebb223aa:
    ...
    no "Ты был всем этим и даже больше. И по сей день я не знаю, почему ты делаешь то, что делаешь для меня, но я так благодарна тебе. Ты как мечта..."
...
translate russian v12_valentine_4565bcd2:
    ...
    no "И стоя здесь сейчас, я чувствую, что нахожусь именно там, где должна быть... Я люблю тебя. *Улыбается*"
...
translate russian v12_valentine_f054e8f8:
    ...
    cl "*Шепот* Ого, она не смогла приберечь всё это для своего парня? *Улыбается*"
...
translate russian v12_valentine_88ba17fb:
    ...
    cl "*Шепот* О! Да, хаха. Он пригласил меня на свидание, когда мы были в Лондоне... Это было так мило."
...
translate russian v12_valentine_97915300:
    ...
    u "Нора, я помню, как жила одна на улице, не имея ничего, кроме одежды."
...
translate russian v12_valentine_7a2149d8:
    ...
    u "В тот день, когда ты подошла ко мне, я думал, что получу пару долларов за сэндвич с курицей, но в итоге я получил лучшие цифры, на которые только я мог надеяться - число, чтобы получить возможность."
...
translate russian v12_valentine_ace4974f:
    ...
    u "Я работаю уже несколько дней, и я не получу свой первый чек, пока не проработаю две недели, но...  Я хотел отплатить тебе за помощь, и вот я и здесь. Клянусь тебе вечно."

# game/v12/scene16.rpy:736
translate russian v12_valentine_24071ba9:

    # no "So kind of you. *Chuckles*"
    no "Так любезно с вашей стороны. *Хихикает*"
...
translate russian v12_valentine_81245ec6:
    ...
    charli "Даже на две секунды не может быть серьезным..."
...
translate russian v12_valentine_92e5d7cf:
    ...
    bishop "Я не слышал таких клятв раньше, но... Клятвы есть клятвы, я полагаю."
...
translate russian v12_valentine_588dcce5:
    ...
    u "Нора, я не всегда делал лучший выбор в жизни или имел лучшие цели в жизни... Но когда я встретил тебя, я начал смотреть на вещи немного по-другому."
...
translate russian v12_valentine_86db312c:
    ...
    u "Я никогда не думал о том, что остепенюсь или буду жить нормальной жизнью, но сейчас я не могу представить, какой была бы моя жизнь без тебя... Ты стала самым ярким светом в моем мире. И я люблю тебя."

# game/v12/scene16.rpy:769
translate russian v12_valentine_c6c1174b:

    # cl "Sounds like you actually mean that, [name]. *Laughs*"
    cl "Звучит так, будто ты правда это имеешь в виду, [name]. *Смеется*"

# game/v12/scene16.rpy:774
translate russian v12_valentine_4c37b67e:

    # u "Imagine it was you I was talking to."
    u "Представь, что я разговаривал с тобой."

# game/v12/scene16.rpy:779
translate russian v12_valentine_c2c12250:

    # li "*Whisper* What was that about?"
    li "*Шепот* Что это было?"
...
translate russian v12_valentine_2b77ba89:
    ...
    cl "*Шепот* Просто хочу убедиться, что он знает, что я единственная девушка, с которой ему следует так разговаривать. *Хихикает*"

# game/v12/scene16.rpy:789
translate russian v12_valentine_57ca5595:

    # bishop "Very beautiful vows, my son."
    bishop "Очень красивые обеты, сын мой."
...
translate russian v12_valentine_a0fbc992:
    ...
    bishop "Обычно в этот момент наша прекрасная пара целуется, закрепляя свой союз."
...
translate russian v12_valentine_97daa0de:
    ...
    lee "Вообще-то, вы забыли спросить, есть ли у кого-нибудь возражения."
...
translate russian v12_valentine_314f435d:
    ...
    bishop "Я также забыл упомянуть, что любые прерывания были достойны удаления с церемонии."
...
translate russian v12_valentine_e702f97f:
    ...
    bishop "Итак, я надеюсь, что вам понравилась презентация. Это все, что я приготовил для вас, так что если у вашего учителя нет больше ко мне претензий, вы можете идти."
...
translate russian v12_valentine_e285480a:
    ...
    li "Мы идем в комнату для побега."
...
translate russian v12_valentine_1e984f18:
    ...
    li "Да, правда! Мы собираемся встретиться с Обри там прямо сейчас."
...
translate russian v12_valentine_98c3bed2:
    ...
    li "Хорошо. Это прямо за углом отсюда, так что мы можем дойти пешком."

# game/v12/scene16.rpy:966
translate russian v12_valentine_689409da:

    # charli "So, you're dating Chloe?"
    charli "Так ты встречаешься с Хлоей?"
...
translate russian strings:
    ...
    old "Fist bump"
    new "Дружеский удар кулаками"

    # game/v12/scene16.rpy:815
    old "Kiss her cheek"
    new "Поцелуй её в щеку"
