...
translate russian v12_nora_exploring_d4d0264b:
    ...
    u "*Глубокий вдох* Показалась тебе Европа такой, какой ты её себе представляла?"
...
translate russian v12_nora_exploring_a6c033d6:
    ...
    no "Думаю, я просто плохо осознаю, что мы не в сказочной стране."
...
translate russian v12_nora_exploring_2bc0ee81:
    ...
    u "Эй, я имею в виду... Конечно, приятно верить, что на другой стороне трава зеленее."

# game/v12/scene21.rpy:101
translate russian v12_nora_exploring_92887b86:

    # no "Yet it usually never is."
    no "Но обычно так не бывает."
...
translate russian v12_nora_exploring_ea3d1777:
    ...
    u "Верно... Но только потому, что проблемы преследовали тебя, не значит, что само место не является удивительным."
...
translate russian v12_nora_exploring_192916cc:
    ...
    no "Я знаю, что Европа великолепна, не собираюсь врать. Многое, что я хотела увидеть, мне удалось увидеть, и я получила небольшой отпуск."
...
translate russian v12_nora_exploring_a7bab218:
    ...
    no "Мне не удалось избежать проблем, как я ожидала, но, возможно, это было незрело думать, что я смогу."
...
translate russian v12_nora_exploring_d4b84d7d:
    ...
    u "Это не незрело, просто невозможно. Это был не просто твой отпуск в одиночестве. Крис и Хлоя приехали, и твои проблемы с ними и проблемы с девочками последовали за тобой."
...
translate russian v12_nora_exploring_944f3b21:
    ...
    no "Да, ты прав. Очень жаль, что с этой фабрикой всё так плохо. В поиске Маху ничего не говорилось о том, что она закрыта... *Вздох*"
...
translate russian v12_nora_exploring_4ad6c244:
    ...
    u "Маху?! *Смеется* Кто вообще ей пользуется. Это мертвая поисковая система."
...
translate russian v12_nora_exploring_b6ca6922:
    ...
    no "Да, это точно. Потому что здесь полный пиздец. *Хихикает*"
...
translate russian v12_nora_exploring_fa8d493d:
    ...
    u "Ну, если здесь беспорядок, это не значит, что мы не можем его проверить..."
...
translate russian v12_nora_exploring_83ce8dbf:
    ...
    u "Ладно, не бери в голову. Там нет ничего такого, на что стоило бы обратить внимание."
...
translate russian v12_nora_exploring_9959f4fc:
    ...
    clady "УБИРАЙСЯ ИЗ МОЕГО ДОМА! Va t'en! Va t'en!"
...
translate russian v12_nora_exploring_59d6a0cc:
    ...
    u "Эй, Остынь! ОСТЫНЬ! Пожалуйста, леди, успокойтесь... Что, черт возьми, с тобой не так?"

# game/v12/scene21.rpy:172
translate russian v12_nora_exploring_4bf80e12:

    # no "What is wrong with you?!"
    no "Да что с тобой такое?!"
...
translate russian v12_nora_exploring_25c19795:
    ...
    clady "Потому что вы, дети, валяете дурака в моём чертовом доме!"
...
translate russian v12_nora_exploring_4aa3a163:
    ...
    no "Это заброшенная фабрика, как она может быть твоим домом?"
...
translate russian v12_nora_exploring_6cc54d1a:
    ...
    clady "Я заявила права на эту землю... Теперь уходите! Прежде чем я призову свои войска уничтожить вас..."

# game/v12/scene21.rpy:207
translate russian v12_nora_exploring_fe1c2e87:

    # u "*Whisper* Okay, this bitch is officially crazy."
    u "*Шепот* Ладно, эта сука официально сумасшедшая."
...
translate russian v12_nora_exploring_b4fcdee9:
    ...
    no "Мы не говорим по-французски!"
...
translate russian v12_nora_exploring_42ce4e93:
    ...
    u "Король закончил осмотр, и мы сейчас уйдем."
...
translate russian v12_nora_exploring_28685ffc:
    ...
    clady "*Британский акцент* Подождите, ваше величество. Не могли бы вы остаться на чашку чая?"
...
translate russian v12_nora_exploring_2b580825:
    ...
    u "*Шепот* У нее что, британский акцент? *Хихикает*"
...
translate russian v12_nora_exploring_973bd3a8:
    ...
    no "Мне жаль, но мы не можем остаться. Нам нужно осмотреть другие дома... И король запрещает вам нападать на кого-либо еще, понятно?"
...
translate russian v12_nora_exploring_9e671536:
    ...
    u "*Шепот* Оооо, думаю, ты её разозлила. Ты позволишь ей так с тобой разговаривать?"
...
translate russian v12_nora_exploring_4bf45e0c:
    ...
    no "*Издевается* Послушайте, леди, очевидно, что вы бездомная и, вероятно, нуждаетесь в помощи."
...
translate russian v12_nora_exploring_f2754e90:
    ...
    clady "Я не бездомная, вы сейчас на моей лужайке! Забирай свою жену и уходи сию же минуту."
...
translate russian v12_nora_exploring_05feedfe:
    ...
    no "Я не его жена и не твоя дочь, так что не думай, что можешь мне приказывать."
...
translate russian v12_nora_exploring_629d411b:
    ...
    no "*Хихикает* Я много чего наговорила этой сумасшедшей, не вдавайся в детали."
...
translate russian v12_nora_exploring_db774833:
    ...
    u "Ты была такой храброй, я не знаю, что бы я делал, если бы тебя там не было... Моя героиня!"
...
translate russian v12_nora_exploring_0c9b8f40:
    ...
    u "*Смеется* Как ты себя чувствуешь, Обри?"
