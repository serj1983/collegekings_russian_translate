...
translate russian v12_riddle_riley_80674681:
    ...
    ri "Катакомбы. *Хихикает* Это место следующей подсказки."
...
translate russian v12_riddle_riley_bf7b92d3:
    ...
    u "Я очень сомневаюсь, но... Опять же, я не знаю подсказки."
...
translate russian v12_riddle_riley_0bc325f7:
    ...
    ri "Не сомневайся в моих способностях, [name]. Но если ты хочешь знать, слушай. \"В городе любви, где лежат спящие сердца, не в реке, а там, где лежат предки.\""
...
translate russian v12_riddle_riley_f299b2c1:
    ...
    u "Так почему здесь? \"Где покоятся предки\" может быть любым кладбищем. Черт, это может быть пирамида или музей."
...
translate russian v12_riddle_riley_1c0b4ca5:
    ...
    ri "Во-первых, в Париже нет пирамид. Во-вторых, я видел фотографию катакомб у Дункана. И в-третьих, в обычном кладбище нет ничего особенного."
...
translate russian v12_riddle_riley_3f93b678:
    ...
    u "Райли! Не говори о таких вещах, особенно о месте захоронения. *Хихикает*"
...
translate russian v12_riddle_riley_e3145d74:
    ...
    ri "Что? Я не имела ничего плохого... Я просто говорю, то что касается поиска сокровищ, то, скорее всего, они будут здесь."
...
translate russian v12_riddle_riley_ba6ee298:
    ...
    u "Ненависть к мертвым не приносит тебе пользы. Когда придут зомби, призраки или еще какая нечисть, меня не будет рядом, чтобы помочь тебе. Но по крайней мере, с тобой будет суперсила, и ты сможешь сказать им, голодны ли они. *Смеется*"

# game/v12/scene15.rpy:62
translate russian v12_riddle_riley_87a5867b:

    # ri "Oh my gosh, c'mon already."
    ri "Боже мой, ну хватит уже."
...
translate russian v12_riddle_riley_fe8721fd:
    ...
    ri "Да, а может нет. Начинай искать следующую подсказку... Я уверена, что она где-то здесь."

# game/v12/scene15.rpy:121
translate russian v12_riddle_riley_5a6e5b0e:

    # u "Did you find anything?"
    u "Ты нашла что-нибудь?"
...
translate russian v12_riddle_riley_131d39a7:
    ...
    u "Нет, всё ещё ищу. Говорю тебе, Райли, внизу ничего нет..."
...
translate russian v12_riddle_riley_8e07fad3:
    ...
    u "*Вздох* Я начинаю по-настоящему ненавидеть эти дерьмовые загадки."
...
translate russian v12_riddle_riley_830e231b:
    ...
    ri "Отлично, думаю, всё в порядке. Давайте вернемся и..."
...
translate russian v12_riddle_riley_0aacf53a:
    ...
    ri "Спасибо. Наверное, всё не так уж плохо. *Хихикает* Скорее всего, до свадьбы заживёт, меня больше удивило, чем причинило боль."
...
translate russian v12_riddle_riley_baa4d711:
    ...
    u "Не волнуйся, я тебя держу. Но все, что произошло, дало мне больше причин не любить эту глупую охоту."
...
translate russian v12_riddle_riley_c111357e:
    ...
    ri "Мне нравятся горячие и сексуальные флюиды, это наверное, самая романтичная вещь, которую я когда-либо испытывала."

# game/v12/scene15.rpy:540
translate russian v12_riddle_riley_6c65d9f8:

    # ri "*Chuckles* You're so sweet, [name]."
    ri "*Хихикает* Ты такой милый, [name]."
...
translate russian v12_riddle_riley_612accac:
    ...
    u "Спасибо... Ты даешь мне много поводов для этого. А теперь, давай вернем тебя обратно."

# game/v12/scene15.rpy:550
translate russian v12_riddle_riley_36d4de9b:

    # ri "Actually, I think I'm feeling fine enough to walk."
    ri "Вообще-то, я думаю, что чувствую себя достаточно хорошо, чтобы пройтись."
...
translate russian v12_riddle_riley_50b65115:
    ...
    ri "Кроме того, я уверена, что у мистера Ли есть кое-что для нас, когда мы вернемся."
...
translate russian strings:
    ...
    old "Hold her hand"
    new "Держать её за руку"

    # game/v12/scene15.rpy:590
    old "Scratch your face"
    new "Расцарапать лицо"
