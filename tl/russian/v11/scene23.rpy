...
translate russian v11s23_chris1_250a6e85:
    ...
    ch "Слушай, мужик, прости, но мне нужно разобраться с этим прямо сейчас. Я не могу говорить."
...
translate russian v11s23_chris1_0537ad1e:
    ...
    u "Да, простите... Себастьян все еще пытается разыграть Приматов?"
...
translate russian v11s23_chris1_66895217:
    ...
    ch "Я не думаю, что она захочет говорить со мной, к тому же мне нужно разбираться с делами. Она знала, что я буду занят."

# game/v11/scene23.rpy:86
translate russian v11s23_chris1_de74bfae:

    # u "Dude, look at her, she's not happy."
    u "Чувак, посмотри на нее, она не счастлива."
...
translate russian v11s23_chris1_eff0da5f:
    ...
    ch "Если ты хочешь развеселить её, то пожалуйста. Я пытался поговорить с ней, но она не слушает."

# game/v11/scene23.rpy:96
translate russian v11s23_chris1_e3dd1e26:

    # u "I get what you're saying but... I don't know, man."
    u "Я понимаю, что ты хочешь сказать, но... Я не знаю, чувак."
...
translate russian v11s23_chris1_2212e4a8:
    ...
    ch "Я должен вернуться к делам, [name] у меня осталось всего 30 минут батареи."
...
translate russian v11s23_chris1_7e9eac1d:
    ...
    ch "Не беспокойся, поговорим позже."
...
translate russian v11s23_mrlee1_39d82de1:
    ...
    lee "[name], я когда-нибудь рассказывал тебе о том, как я жил здесь, в Лондоне?"
...
translate russian v11s23_mrlee1_6f9ccfd5:
    ...
    u "Вы сказали, что ездили в заграничную поездку в Китай, но вы никогда не говорили мне, что были в Лондоне."
...
translate russian v11s23_mrlee1_b8dd171f:
    ...
    lee "О, я жил во многих местах. Я осматривал этот музей много лет назад."
...
translate russian v11s23_mrlee1_c1cb191a:
    ...
    lee "Я был симпатичным молодым человеком и так же увлекался историей, как и сейчас."

# game/v11/scene23.rpy:179
translate russian v11s23_mrlee1_c98aeae0:

    # u "I don't doubt it."
    u "Я в этом не сомневаюсь."
...
translate russian v11s23_mrlee1_09128f17:
    ...
    lee "У меня были длинные черные волосы. Люди думали, что я хороший боец, потому что я был... ну, ты понимаешь. Брюс был очень знаменит в то время, и все хотели заниматься каким-нибудь видом боевых искусств."
...
translate russian v11s23_mrlee1_73a68c4e:
    ...
    lee "Студии появлялись повсюду. У меня была семья в Штатах, поэтому я приезжал туда летом. Ты когда-нибудь был за пределами США?"

# game/v11/scene23.rpy:190
translate russian v11s23_mrlee1_6ccb662b:

    # u "Well, I'm in Europe right now."
    u "Ну, я сейчас нахожусь в Европе."
...
translate russian v11s23_mrlee1_2e506317:
    ...
    lee "В Америке я познакомился с прекрасной девушкой. Она была художником, точнее, скульптором. Она вырезала самые изысканные вещи."
...
translate russian v11s23_mrlee1_3be269ff:
    ...
    lee "Она хотела сбежать из школы и всего остального, поэтому я взял ее с собой в Европу."

# game/v11/scene23.rpy:221
translate russian v11s23_mrlee1_81dc0a8d:

    # u "Is the woman you're talking about your wife now?"
    u "Женщина, о которой вы говорите, теперь ваша жена?"
...
translate russian v11s23_mrlee1_16a75a17:
    ...
    lee "Ох, нет... У нас было хорошее время, но она всё испортила. Я решил продолжить посещать школу в Лондоне, несмотря на то, что она хотела, чтобы я бросил."
...
translate russian v11s23_mrlee1_878fee7f:
    ...
    lee "В течение нескольких месяцев она становилась все более и более отстраненной, пока однажды... не ушла."

# game/v11/scene23.rpy:232
translate russian v11s23_mrlee1_71c1fafb:

    # u "Sounds like you missed her."
    u "Похоже, вы скучали по ней."
...
translate russian v11s23_mrlee1_d8ec0c40:
    ...
    lee "Когда она ушла, то оставила после себя скульптуру головы мужчины. Она работала над ней долгое время."
...
translate russian v11s23_mrlee1_f249a306:
    ...
    lee "Используя те ниточки, которые у меня были, я добился того, чтобы ее работа была помещена в этот самый музей. Эта скульптура принадлежит ей."
...
translate russian v11s23_mrlee1_1f16c575:
    ...
    lee "Не очень. Выяснилось, что это скульптура мужчины, с которым она мне изменяла, и, подумать только, это я подарил ее музею, где она находится уже 36 лет."
...
translate russian v11s23_mrlee1_7f163e77:
    ...
    u "*Смеется* Мне жаль, но это была лучшая концовка истории, которую я когда-либо слышал."

# game/v11/scene23.rpy:261
translate russian v11s23_mrlee1_c5169935:

    # lee "It wasn't so funny back then."
    lee "Тогда это было не так смешно."
...
translate russian v11s23_mrlee1_68eaf78b:
    ...
    lee "Каждый раз, когда я возвращаюсь, а оно все еще здесь, это портит мне настроение. Я слишком много раз просил убрать его."

# game/v11/scene23.rpy:278
translate russian v11s23_mrlee1_e129e2a7:

    # u "Maybe you should just stop coming to see it."
    u "Может, вам просто не стоит приходить сюда?"
...
translate russian v11s23_mrlee1_9bac7e8d:
    ...
    lee "Приехать посмотреть на него - единственный способ узнать, исчезло ли оно. Музей прекратил переписку со мной."
...
translate russian v11s23_mrlee1_1f401c61:
    ...
    lee "*Вздох* Дай мне минуту, ладно [name]?"
...
translate russian v11s23_riley1_bbaa83e9:
    ...
    ri "Посмотри, какой он большой! Интересно, это мальчик или девочка..."
...
translate russian v11s23_riley1_0496e64d:
    ...
    ri "Если бы эти существа были сейчас живыми, ты знаешь, мы могли бы общаться с ними и гладить их, и они бы не напали на нас? Они пасущиеся травоядные."

# game/v11/scene23.rpy:346
translate russian v11s23_riley1_fa6bc3fc:

    # u "Like prehistoric cows."
    u "Как доисторические коровы."
...
translate russian v11s23_riley1_ae075c80:
    ...
    u "Стой тут, пока я схожу за пистолетом Дункана, потом можешь наслаждаться."
...
translate russian v11s23_riley1_3b2e4162:
    ...
    u "Раз уж тебе так нравится видеть страдающих людей, посмотрим, насколько тебе это понравится."
...
translate russian v11s23_riley1_b784a2da:
    ...
    ri "*Шепот* Забавно. Но не давай обещаний, которые не сможешь выполнить, [name]."

# game/v11/scene23.rpy:417
translate russian v11s23_riley1_7804d17d:

    # u "I always keep my promises."
    u "Я всегда выполняю свои обещания."
...
translate russian v11s23_riley1_bf53329c:
    ...
    ri "Если бы ты попытался быть более дружелюбным... Просто знай, что я никогда не проигрываю."

# game/v11/scene23.rpy:433
translate russian v11s23_riley1_dac19108:

    # u "*Laughs* That is not what I sound like."
    u "*Смеется* Это не то, что я говорю."
...
translate russian v11s23_riley1_61231aec:
    ...
    ri "Это был всего лишь один бой! И она играла грязно... не волнуйся, я верну её."
...
translate russian v11s23_riley1_ea9d1593:
    ...
    lee "Пожалуйста, скажи мне, что ты их не трогаешь. Починка обойдется в целое состояние."
...
translate russian v11s23_riley1_100aa630:
    ...
    ri "Я говорила тебе не начинать войну со мной, но ты не смог устоять. Надеюсь, ты готовы."
...
translate russian v11s23_riley1_4401ed4d:
    ...
    u "(Она немного более дерзкая, чем я думал.)"
...
translate russian v11s23_penelope1_b079dea9:
    ...
    pe "У меня возникло дежавю, когда мы впервые встретились. Когда я начала уходить, ты схватил меня за руку, вот так просто."

# game/v11/scene23.rpy:628
translate russian v11s23_penelope1_0801cb04:

    # u "Haha, I did do that."
    u "Хаха, я так и сделал."
...
translate russian v11s23_penelope1_5ac7f140:
    ...
    pe "Потому что он по-прежнему заставляет меня делать всё. Даже самые незначительные мелочи, которые он не хочет делать, он просит меня."

# game/v11/scene23.rpy:648
translate russian v11s23_penelope1_d8b7ecd2:

    # u "What are you headed to do now?"
    u "Что ты собираешься делать сейчас?"
...
translate russian v11s23_penelope1_3c022a74:
    ...
    pe "Он попросил меня принести воды на случай, если кто-нибудь захочет. Я уже всё осмотрела, но нигде найти."

# game/v11/scene23.rpy:658
translate russian v11s23_penelope1_2a15028b:

    # u "Where'd he say they were?"
    u "Где, по его словам, нужно найти"
...
translate russian v11s23_penelope1_1e25afa5:
    ...
    pe "Он сказал, что персонал разрешил взять что-нибудь из шкафа для персонала, но я не видела ни одного."
...
translate russian v11s23_penelope1_fed06866:
    ...
    u "Ты думаешь, что сказав мне это, я перестану тебе помогать?"
...
translate russian v11s23_penelope1_2db49b43:
    ...
    pe "Спасибо, что помог мне. Если хочешь возвращайся, я спрячусь здесь на секунду."
...
translate russian v11s23_penelope1_3aceb8c1:
    ...
    pe "Как ты думаешь, когда мы вернемся, мы сможем пойти на настоящее свидание?"
...
translate russian v11s23_penelope1_5e7b9e03:
    ...
    pe "Хотя мы не можем пойти в боулинг, я бы не хотела так поступать с тобой. *Хихикает*"

# game/v11/scene23.rpy:796
translate russian v11s23_penelope1_0c9bd87e:

    # u "Haha, what do you wanna do?"
    u "Хаха, так куда ты хочешь?"
...
translate russian v11s23_penelope1_1c4e7253:
    ...
    u "О, я помогаю тебе только для того, чтобы завоевать твоё доверие. После того, как я это сделаю, я заставлю тебя дать мне банковские данные и ограблю, забрав всё, что у тебя есть."
...
translate russian v11s23_penelope1_fbb09452:
    ...
    pe "Я понимаю, что ты пытаешься быть смешным, но я достаточно глупа, чтобы на это купиться. *Хихикает*"

# game/v11/scene23.rpy:931
translate russian v11s23_penelope1_328240db:

    # u "The genius Penelope is gullible?"
    u "Гениальная Пенелопа доверчива?"
...
translate russian v11s23_penelope1_90b9a7d6:
    ...
    u "Не волнуйся, я тоже довольно доверчив. Вот почему надо мной так издевались, когда я был маленьким."

# game/v11/scene23.rpy:946
translate russian v11s23_penelope1_5a48d961:

    # pe "Oh wow, I'm so sorry about that."
    pe "Ух ты, мне очень жаль."
...
translate russian v11s23_penelope1_52ecd2af:
    ...
    pe "Знаешь, ты напоминаешь мне моего любимого актера. *Хихикает*"
...
translate russian v11s23_penelope1_74578973:
    ...
    u "Тот, что из фильма про стриптизёров? Значит, я напоминаю тебе стриптизёра?"

# game/v11/scene23.rpy:1002
translate russian v11s23_penelope1_9122968a:

    # pe "No no, you just look like him."
    pe "Нет-нет, ты просто похожа на него."
...
translate russian v11s23_freeroamend_5f78dbda:
    ...
    u "*Пение* Она одинокая одинокая девушка, в одиноком одиноком мире."
...
translate russian v11s23_freeroamend_f016bab9:
    ...
    no "Чего ты хочешь? Пытаешься подменить Чарли?"
...
translate russian v11s23_freeroamend_013edef6:
    ...
    u "Я хочу, чтобы ты наслаждалась поездкой, на планирование которой ты потратила несколько недель."
...
translate russian v11s23_freeroamend_c7dc61ea:
    ...
    no "*Вздох* Как? Не получая внимания от бойфренда-трудоголика, находясь рядом с фальшивой стервой по имени Хлоя, или гуляя по этому скучному музею?"
...
translate russian v11s23_freeroamend_afd895ff:
    ...
    u "Я бы сказал, что поездка прошла не так, как ты думала."
...
translate russian v11s23_freeroamend_cbcbbb24:
    ...
    no "Да, не так. И, чёрт, как... это скучно. У меня на уме были куда более интересные вещт, чтобы сделать и посмотреть в Лондоне."
...
translate russian v11s23_freeroamend_f3c76b38:
    ...
    no "Много. Я собиралась посмотреть на Биг Бен, но мистер Ли заставил нас приехать сюда."
...
translate russian v11s23_freeroamend_bae6df78:
    ...
    u "Да, это довольно скучно, но, может быть, дальше будет лучше."
...
translate russian v11s23_freeroamend_109968fb:
    ...
    no "Я тоже так думала, но теперь начинаю сомневаться."
...
translate russian v11s23_freeroamend_c859c55c:
    ...
    lee "Вперёд, студенты! Надеюсь, вам понравилось в музее, я знаю, что Райли понравилось."
...
translate russian v11s23_freeroamend_d3d7efd3:
    ...
    no "Ты правда хочешь это сделать?"
...
translate russian v11s23_freeroamend_74e504bc:
    ...
    u "Эй, это наша поездка. Если мы не получаем удовольствия, зачем тогда оставаться?"
...
translate russian v11s23_freeroamend_2733a2eb:
    ...
    no "*Смеётся* Как мы выберемся отсюда, не попавшись?"
...
translate russian v11s23_freeroamend_5e1d9138:
    ...
    no "Наконец-то я могу начать наслаждаться этой поездкой. Спасибо, [name]."

# game/v11/scene23.rpy:1225
translate russian v11s23_freeroamend_147ecf8c:

    # u "Glad I could help."
    u "Я рад, что смог помочь."
...
translate russian strings:
    ...
    # game/v11/scene23.rpy:383
    old "Laugh it off"
    new "Смеяться над этим"

    # game/v11/scene23.rpy:520
    old "Snitch on Riley"
    new "Настучать на Райли"

    # game/v11/scene23.rpy:520
    old "Don't snitch on Riley"
    new "Не доносить на Райли"
