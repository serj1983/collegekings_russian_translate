...
translate russian v11_bartender_hotel_chat_3c7dd9d4:
    ...
    bartender "Ты самая лучшая компания, которая была у меня за весь год... большинство людей ходят в настоящий бар."

# game/v11/scene27.rpy:15
translate russian v11_bartender_hotel_chat_8300de8f:

    # u "Why leave when the same stuff is right here?"
    u "Зачем уходить, когда то же самое находится прямо здесь?"
...
translate russian v11_bartender_hotel_chat_937fa394:
    ...
    bartender "*Хихикает* Вот что я говорю уже много лет."
...
translate russian v11_bartender_hotel_chat_94e9bf0a:
    ...
    u "Лет? Ты так говоришь, как будто ты старая. Ты не недалеко от моего возраста."
...
translate russian v11_bartender_hotel_chat_90787cbb:
    ...
    bartender "Что ж, спасибо, но вся заслуга в этом принадлежит хорошим генам. Мне за тридцать."

# game/v11/scene27.rpy:35
translate russian v11_bartender_hotel_chat_1fc1a954:

    # u "Wow, you look great."
    u "Вау, ты выглядишь великолепно."
...
translate russian v11_bartender_hotel_chat_1f334c22:
    ...
    u "Тьфу, я имел в виду хорошо, в смысле... ты выглядишь намного моложе своих тридцати лет."
...
translate russian v11_bartender_hotel_chat_31eab7c2:
    ...
    bartender "Вы тоже неплохо выглядите. Как тебя зовут?"
...
translate russian v11_bartender_hotel_chat_8e689af4:
    ...
    bartender "Мне это нравится, это мило. Ты тоже симпатичный."
...
translate russian v11_bartender_hotel_chat_547b208b:
    ...
    bartender "*Хихикает* Значит, я не расстрою ни одну юную леди."
...
translate russian v11_bartender_hotel_chat_3d7023e0:
    ...
    bartender "Ну, я бы не хотел кого-то ревновать, флиртуя с тобой."
...
translate russian v11_bartender_hotel_chat_5c170ea5:
    ...
    bartender "Я видела много симпатичных девушек с тобой в поездке, уверен, ты тоже считаешь их очень красивыми. Так что насчет меня?"
...
translate russian v11_bartender_hotel_chat_9683ffbe:
    ...
    bartender "Я не думаю, что ты сможешь справиться с женщиной моего возраста."
...
translate russian v11_bartender_hotel_chat_52a670c3:
    ...
    bartender "Ты выглядишь взволнованным."
...
translate russian v11_bartender_hotel_chat_389aa1cd:
    ...
    bartender "*Смеётся* Я скучающий бармен, и мне нравится дразнить таких парней, как ты. Это то, что делает эту работу интересной."
...
translate russian v11_bartender_hotel_chat_2dcd759c:
    ...
    bartender "Если тебе надоело быть одиноким у моей стойки, я с удовольствием займусь уборкой."
...
translate russian v11_bartender_hotel_chat_2902a1e3:
    ...
    bartender "Было приятно пообщаться, спокойной ночи."
...
translate russian v11_bartender_hotel_chat_7d9c8a18:
    ...
    bartender "Значит, ты называешь девушку уродиной, а потом больше не хочешь разговаривать?"
...
translate russian v11_bartender_hotel_chat_0f808041:
    ...
    bartender "Так ты назвал меня уродиной!"
