...
translate russian v11_apes_manhunt_0f468972:
    ...
    ry "Мне кажется, я знаю, и если я прав, вам это не понравится."
...
translate russian v11_apes_manhunt_b44db7e9:
    ...
    gr "Я расскажу тебе, что происходит. Каждый год сюда привозят новичков, и мы играем в охоту на людей."

# game/v11/scene9.rpy:82
translate russian v11_apes_manhunt_736748b2:

    # cal "What's manhunt?"
    cal "Что за охота на людей?"
...
translate russian v11_apes_manhunt_f4c2cefc:
    ...
    ca "Это охота на человека, теперь перестань задавать столько чертовых вопросов и дай ему закончить объяснения."
...
translate russian v11_apes_manhunt_a8030853:
    ...
    gr "Ты будешь бежать, ты будешь прятаться. Если кто-то из нас поймает тебя, мы выбьем из тебя всё дерьмо. Победит тот, кто останется последним."
...
translate russian v11_apes_manhunt_4c9d8fa0:
    ...
    gr "Это будет весело. Вы готовы, ребята?"
...
translate russian v11_apes_manhunt_56eb8dab:
    ...
    u "Почему ты здесь, а не с ними, и почему ты бежал?"
...
translate russian v11_apes_manhunt_e955642e:
    ...
    ca "Ты только что назвал меня новичком?"
...
translate russian v11_apes_manhunt_47408647:
    ...
    gr "Уверен, что теперь он будет очень мило разговаривать с тобой, Кэмерон. *Хихикает*"
...
translate russian v11_apes_manhunt_46d3fe8f:
    ...
    gr "Успокойся, не так уж и больно. Пойдем к лошади, пора победителю выбрать худшего проигравшего."
...
translate russian v11_apes_manhunt_33afbe0c:
    ...
    u "Просто чтобы мы все поняли, пошел ты Калеб."
...
translate russian v11_apes_manhunt_2cd564fd:
    ...
    ry "Подожди, он проделал этот трюк \"оставайся здесь\" и с тобой тоже."
...
translate russian v11_apes_manhunt_20442b36:
    ...
    cal "Слушай, меня били тысячу раз еще до того, как мы начали, я не собираюсь снова."
...
translate russian v11_apes_manhunt_733127fe:
    ...
    u "(Они, вероятно, все еще слишком близко, чтобы я мог остановиться и спрятаться.)"

# game/v11/scene9.rpy:444
translate russian v11_apes_manhunt_d3c64ade:

    # u "(Okay, time to find a nice hiding spot.)"
    u "(Ладно, пора найти хорошее укрытие.)"
...
translate russian v11_apes_manhunt_1d623e3f:
    ...
    gr "Не волнуйся, я только что прихлопнул Калеба."
...
translate russian v11_apes_manhunt_00344e43:
    ...
    ran "Вы, должно быть, Грейсон, вот Бронко для охоты. Верните его к утру."
...
translate russian v11_apes_manhunt_022f8b04:
    ...
    u "Ты, наверное, подарок для лузеров. Может быть, если я останусь рядом с тобой, я стану хорошим."

# game/v11/scene9.rpy:685
translate russian v11_apes_manhunt_79379766:

    # ry "Look man, you don't have to slam me!"
    ry "Слушай, чувак, тебе не обязательно меня бить!"
...
translate russian v11_apes_manhunt_5d19864c:
    ...
    ca "Ты прятался здесь на виду? Ты что, идиот?"
...
translate russian v11_apes_manhunt_00344e43_1:
    ...
    # ran "You must be Grayson, here's the Bronco for the manhunt. Have him back by morning."
    ran "Ты, должно быть, Грейсон, вот Бронко для охоты. Верните его к утру."
...
translate russian v11_apes_manhunt_f3233698:
    ...
    gr "Как бы ни было весело, пришло время для наказания. Победитель, выбирай, кто наш неудачник."

# game/v11/scene9.rpy:938
translate russian v11_apes_manhunt_d68b9a02:

    # cal "Sorry [name], but you gotta take this one."
    cal "Извини, [name], но ты должен ответить на этот вопрос."
...
translate russian v11_apes_manhunt_d0713e28:
    ...
    ca "Это был вопрос, который я только что услышал?"
...
translate russian v11_apes_manhunt_3925a307:
    ...
    ry "Это не похоже на наказание, это похоже на веселье."
...
translate russian v11_apes_manhunt_1449be25:
    ...
    gr "В следующем году мы вернемся к правильным наказаниям. Эта лошадь должна была устроить тебе ад..."
...
translate russian v11_horse_fall_0cda81d4:
    ...
    gr "*Смеется* Это было лучше, чем когда мы заставили всех новичков бежать через прошлогодний костер! Пойдемте назад."
...
translate russian v11_mc_horse_room_174082b4:
    ...
    u "(Клянусь, они хотят нас убить. Мне нужно хорошенько выспаться)."
