...
translate russian v11_ride_with_mrlee_cc3ce54f:
    ...
    lee "Почему нет? Они взрослые мужики и ясно дали понять, что не заинтересованы в том, чтобы делать то, что я предлагаю, так что я просто извинюсь. Разве ты не хотел остаться с ними?"
...
translate russian v11_ride_with_mrlee_b11c4a26:
    ...
    u "Я бы не хотел слушать, как они ругаются всю дорогу до отеля."
...
translate russian v11_ride_with_mrlee_c45377bd:
    ...
    lee "*Вздох* Думаю, ты немного взрослее своих друзей. Или ты просто захотел прокатиться."

# game/v11/scene37a.rpy:51
translate russian v11_ride_with_mrlee_d1f206e7:

    # u "*Laughs* A little bit of both."
    u "*Смеется* Немного того и другого."
...
translate russian v11_ride_with_mrlee_43629334:
    ...
    lee "Я ценю твою честность. У меня есть вопрос, если ты позволишь мне."
...
translate russian v11_ride_with_mrlee_48b29642:
    ...
    lee "Я задаю тебе этот вопрос, потому что у обоих этих мальчиков на лбу написаны их личности."
...
translate russian v11_ride_with_mrlee_4156ea0e:
    ...
    lee "Имре четко выражает свои мысли, не особо заботясь об этом. Он предан до мелочей, но не терпит, когда его предают или не уважают. Хотя иногда даже сам предаёт или не уважает других."

# game/v11/scene37a.rpy:87
translate russian v11_ride_with_mrlee_bad9efb4:

    # u "(Does he know something about Imre that I don't?)"
    u "(Он знает об Имре, чего не знаю я?)"

# game/v11/scene37a.rpy:88
translate russian v11_ride_with_mrlee_b9036c5b:

    # u "What about Ryan?"
    u "А что насчет Райна?"
...
translate russian v11_ride_with_mrlee_2519737e:
    ...
    lee "Райн более сложен, но всё же достаточно понятен. Он скорее реактор, чем актер, как Имре. Райн не говорит миру, как ему двигаться."
...
translate russian v11_ride_with_mrlee_2365a16b:
    ...
    lee "Он наблюдает, как движется мир, а затем решает, что он будет делать. Посмотри на них прямо сейчас."
...
translate russian v11_ride_with_mrlee_0b4c5759:
    ...
    lee "Спросите себя, если бы Имре не сказал ни слова за всё время, пока они ссорились, стали бы они ссориться вообще?"
...
translate russian v11_ride_with_mrlee_41d104ad:
    ...
    u "Нет, наверное, нет. Вы хотите сказать, что во всем виноват Имре?"
...
translate russian v11_ride_with_mrlee_df64cced:
    ...
    lee "Вовсе нет. Если я ударю кулаком рядом с твоим лицом, а ты подставишь голову прямо на пути моего кулака, это твоя вина."
...
translate russian v11_ride_with_mrlee_51ae5f42:
    ...
    lee "Райн позволяет Имре беспокоить его. Он мог бы легко \"стать лучшим человеком\" и уйти, но он этого не делает, потому что они ведут себя как дети."
...
translate russian v11_ride_with_mrlee_19bc0e56:
    ...
    lee "[name], ты знаешь, что значит быть мужчиной и вести себя как взрослый?"
...
translate russian v11_ride_with_mrlee_45c88e10:
    ...
    u "Ну, у тех, у кого есть обязанности, нет другого выбора, кроме как вести себя как взрослый, так что, я думаю, у них есть ответственность."
...
translate russian v11_ride_with_mrlee_e45dbf73:
    ...
    u "Ну, чтобы быть кем-то из них, ты должен вести себя по-взрослому."
...
translate russian v11_ride_with_mrlee_b8e551d5:
    ...
    lee "Чтобы быть мужчиной, быть взрослым, нам необходимо осознавать своё положение и действовать соответственно. Если ты муж, отец и работник, то ты должен знать об этом и действовать соответственно."
...
translate russian v11_ride_with_mrlee_a0ca5a77:
    ...
    lee "Ты и все твои друзья студенты, находятся под моей и мисс Роуз опекой."
...
translate russian v11_ride_with_mrlee_c7fca150:
    ...
    lee "Поэтому вести себя соответствующим образом означает вести себя так, как будто вы находитесь в школе, и выполнять все соответствующие и разумные указания, которые мы даем. Твои два друга не понимают этого."

# game/v11/scene37a.rpy:153
translate russian v11_ride_with_mrlee_ac67b2f0:

    # u "Yeah, it was getting pretty hard to handle them."
    u "Да, с ними становилось довольно трудно справляться."
...
translate russian v11_ride_with_mrlee_3a9b280c:
    ...
    lee "Это было бы преуменьшением. Возможно, то, что их заставили работать вместе над поиском пути домой, поможет им решить их проблемы."
...
translate russian v11_ride_with_mrlee_0d610aa1:
    ...
    lee "Именно поэтому я презираю современную греческую культуру. Она уничтожает мораль вместо преданности."

# game/v11/scene37a.rpy:164
translate russian v11_ride_with_mrlee_606fc3b0:

    # u "Were you in a fraternity?"
    u "Вы были в братстве?"
...
translate russian v11_ride_with_mrlee_f8b3330d:
    ...
    lee "Я был им и горжусь этим. Это было совсем не похоже на те братства, которые у нас сегодня. Если бы у меня было право голоса в том, как обстоят дела в нашей школе, всё было бы совсем по-другому."

# game/v11/scene37a.rpy:174
translate russian v11_ride_with_mrlee_b450e9d8:

    # u "(Good thing you don't have a say.)"
    u "(Хорошо, что у тебя нет права голоса.)"
...
translate russian v11_ride_with_mrlee_dab23651:
    ...
    lee "Да, тебя. Что ты получаешь от этого? Я задал Имре тот же вопрос до того, как он перешел к \"Волкам\", и мне не понравился его ответ."
...
translate russian v11_ride_with_mrlee_e1af09c8:
    ...
    lee "Я скажу тебе вот что: если ты хоть слово скажешь о том, что девушки - твоя причина, я позволю тебе пройти остаток пути прямо сейчас."
...
translate russian v11_ride_with_mrlee_bad5d485:
    ...
    u "Мне нравится братство, правда. В конце концов, я знаю, что они все прикрывают мою спину."
...
translate russian v11_ride_with_mrlee_e83a44f2:
    ...
    u "И, честно говоря, мне нравится это волнение. Сначала я не был уверен, хотел ли я вступить в братство, но я рад, что сделал это."
...
translate russian v11_ride_with_mrlee_eb8c677d:
    ...
    u "Ты никогда не знаешь, чего ожидать, и независимо от того, какие сумасшедшие вещи могут произойти, по крайней мере, ты никогда не сможешь сказать, что тебе было скучно. *Хихикает*"
...
translate russian v11_ride_with_mrlee_dba4031e:
    ...
    lee "Что ж, это определенно лучший ответ, чем мне давали раньше."
...
translate russian v11_ride_with_mrlee_3eb6c121:
    ...
    u "Мистер Ли, я должен спросить. Почему всё это так важно для вас, почему вы были готовы тащить нас сюда всю дорогу только для того, чтобы всё уладить?"
...
translate russian v11_ride_with_mrlee_593b095c:
    ...
    u "Любой другой учитель просто бы закрыл глаза, наложил дисциплинарное взыскание и на этом всё закончилось"
...
translate russian v11_ride_with_mrlee_dcd30c55:
    ...
    lee "*Вздох* Как я пытался объяснить ранее, в ситуациях, которые переживают ваши студенты, я вижу во многом себя молодого."
...
translate russian v11_ride_with_mrlee_93b2ba57:
    ...
    lee "Если я смогу помочь одному из вас или всем вам, это будет того стоить. Но я не собираюсь ни с кем нянчиться. Вместо этого я дам вам всем ясность и честную попытку всё исправить."
...
translate russian v11_ride_with_mrlee_f881cded:
    ...
    lee "Может быть, это звучит не так уж и сильно, когда я говорю, большинство из них не поймёт даже этого"
...
translate russian v11_ride_with_mrlee_c68c4649:
    ...
    u "Нет, я понимаю, это действительно очень круто с твоей стороны. Я действительно уважаю это."
...
translate russian v11_ride_with_mrlee_7df915ef:
    ...
    lee "Позволь мне сказать тебе кое-что [name], в нашей жизни мы совершаем ошибки, и мы также делаем выбор, который, по нашему мнению, не является ошибкой, но другие страдают от них."

# game/v11/scene37a.rpy:249
translate russian v11_ride_with_mrlee_86caaf18:

    # lee "Listen closely to what I'm about to say."
    lee "Внимательно слушайте то, что я сейчас скажу."
...
translate russian v11_ride_with_mrlee_93c1e437:
    ...
    lee "Не жалей о решениях, которые вы приняли до этого момента своей жизни. Примите свои решения и помните, что мир будет продолжаться независимо от того, что вы делаете."
...
translate russian v11_ride_with_mrlee_0453f93c:
    ...
    lee "Так что наслаждайтесь жизнью. Если вы будете сожалеть о прошлом, это разрушит ваше будущее. Прошлое - это прошлое, будущее - это будущее, но прямо здесь, прямо сейчас... это подарок."
...
translate russian v11_ride_with_mrlee_4d07234a:
    ...
    lee "Вот почему он называется настоящим. Не позволяйте другим разрушать ваше настоящее. Вы понимаете, о чем я говорю?"

# game/v11/scene37a.rpy:265
translate russian v11_ride_with_mrlee_78d3c42b:

    # u "(Does he know everything that's going on?)"
    u "(Знает ли он все, что происходит?)"
...
translate russian v11_ride_with_mrlee_52127ebb:
    ...
    u "Уверен, что это именно то, что мне нужно было услышать, мистер Ли. В последнее время я через многое прошёл, и некоторые размышления были частью этого."

# game/v11/scene37a.rpy:271
translate russian v11_ride_with_mrlee_275324ad:

    # lee "I know [name], I know."
    lee "Я знаю [name], я знаю."

# game/v11/scene37a.rpy:276
translate russian v11_ride_with_mrlee_302362af:

    # u "Wait, you know about... everything?"
    u "Подождите, вы знаете... обо всём?"
...
translate russian v11_ride_with_mrlee_d0173461:
    ...
    lee "Позвольте мне уточнить... Я не знаю, что именно происходит, но ты мой студент. Если бы я не заметил изменений в твоём поведении или взаимодействии с другими студентами, я был бы плохим профессором."
...
translate russian v11_ride_with_mrlee_5cfa34ad:
    ...
    lee "Я заметил некоторые ваши разговоры с одним конкретным студентом, и я видел, что в последнее время вы ведете себя немного непохоже на себя. Просто живи своей жизнью, хорошо? Зрелая, ответственная жизнь, но твоя жизнь."

# game/v11/scene37a.rpy:287
translate russian v11_ride_with_mrlee_50f6cedd:

    # u "Yeah, for sure. Um, thank you Mr. Lee, really."
    u "Да, конечно. Спасибо, мистер Ли, правда."
...
translate russian v11_ride_with_mrlee_69cf1ac4:
    ...
    lee "Спасибо, что ты меня слушаешь. Многолетняя преподавательская деятельность помогает понять, слушают тебя люди или нет."
...
translate russian v11_imre_and_ryan_9eb6fbd8:
    ...
    u "Я не могу злиться на него. Что с вами не так, ребята? Это было чертовски неловко."
...
translate russian v11_imre_and_ryan_7991279d:
    ...
    u "Ты же понимаешь, что он вернется в отель один, и люди будут спрашивать его, где мы? Что он собирается сказать, что мы все вышли выпить кофе?"
...
translate russian v11_imre_and_ryan_b4a5c1f5:
    ...
    ry "Бро, расслабься. Я уже сказал, что мне жаль, что втянули тебя в эту историю. Нам просто нужно вернуться до того, как это сделает мистер Ли, или придумать историю, объясняющую, где мы были."
...
translate russian v11_imre_and_ryan_5e8c252f:
    ...
    imre "Почему бы тебе не взять на себя ответственность? Это твоя вина."
...
translate russian v11_imre_and_ryan_62a094da:
    ...
    imre "Как я уже говорил, если бы ты не говорил обо мне всякое дерьмо, у нас не было бы никаких проблем, кроме того факта, что ты Примат."
...
translate russian v11_imre_and_ryan_ab388832:
    ...
    imre "Это уже другая проблема, для другого времени."
...
translate russian v11_imre_and_ryan_92007a48:
    ...
    ry "Я НЕ СМЕЯЛСЯ НАД ТОБОЙ! ТВОЯ ТУПАЯ ЗАДНИЦА ДАЖЕ НЕ ЗНАЕТ, ЧТО, БЛЯДЬ, СКАЗАЛ ГРЕЙСОН, ДА?"
...
translate russian v11_imre_and_ryan_6fcdcaa3:
    ...
    imre "Если там не было ничего плохого и я веду себя как сумасшедший, тогда расскажи мне, что он сказал."

# game/v11/scene37a.rpy:389
translate russian v11_imre_and_ryan_b5f95b28:

    # ry "I don't have to tell you what he said."
    ry "Мне не нужно рассказывать тебе, что он сказал."
...
translate russian v11_imre_and_ryan_61920305:
    ...
    imre "Нет, правда. Если он не сказал ничего плохого обо мне, и ты не был частью шутки, или что бы это ни было, я извинюсь, и всё закончится."
...
translate russian v11_imre_and_ryan_108f9b54:
    ...
    u "Райн, правда? Ты помнишь, что он сказал."
...
translate russian v11_imre_and_ryan_6566c322:
    ...
    u "Если он даже не помнит, значит, всё было не так серьезно."
...
translate russian v11_imre_and_ryan_d6929f78:
    ...
    imre "Что? Ты не можешь верить в его бредни. Что сказал Грейсон, Райн?"
...
translate russian v11_imre_and_ryan_0b5d8ee4:
    ...
    ry "*Вздох* Хорошо. Грейсон сказал, и я цитирую его, это его слова, не мои. \"Имре - такой же жалкий боец, как и его брат. Я буду удивлен, если он продержится тридцать секунд."
...
translate russian v11_imre_and_ryan_ed82b317:
    ...
    imre "Ну, я знал, что вы, ребята, говорили о моем брате, и это вывело меня из себя. Тебе следовало сказать что-нибудь Грейсону или, по крайней мере, не смеяться."
...
translate russian v11_imre_and_ryan_46832b4f:
    ...
    ry "Ты, твой брат и Грейсон - всё это не мое дело. Очевидно, это не было причиной, по которой я смеялся."
...
translate russian v11_imre_and_ryan_b3bd22a3:
    ...
    imre "Тебе вообще не следовало смеяться. Тебе следовало либо сказать что-нибудь о том, что он несет чушь, либо промолчать."
...
translate russian v11_imre_and_ryan_d2e9d857:
    ...
    ry "Ладно, сука, что теперь? С этим покончено, и что теперь?"
...
translate russian v11_imre_and_ryan_1d40c6b6:
    ...
    ry "*Издевается* Я едва ли извиняюсь, когда на самом деле делаю что-то не так, и я не извиняюсь, когда я ни хрена не сделал."

# game/v11/scene37a.rpy:486
translate russian v11_imre_and_ryan_26b513f4:

    # imre "Then we still have a problem."
    imre "Тогда у нас всё ещё есть проблема."
...
translate russian v11_imre_and_ryan_653b7b6d:
    ...
    ry "Пусть будет так. Но вот что я тебе скажу: продолжай наезжать на меня и делать свои мелкие замечания, и я быстро положу этому конец."

# game/v11/scene37a.rpy:496
translate russian v11_imre_and_ryan_1c48624c:

    # imre "Just say when, I'm always ready."
    imre "Только скажи когда, я всегда готов."
...
translate russian v11_imre_and_ryan_7cf92a7f:
    ...
    u "Ребята, вы можете хоть на пару секунд успокоиться!? Некоторые из нас хотят вернуться в отель."
...
translate russian v11_imre_and_ryan_81887bab:
    ...
    u "Я не хотел, чтобы меня вообще сюда тащили, и уж точно не хотел, чтобы вы двое спорили."
...
translate russian v11_imre_and_ryan_c22dd398:
    ...
    u "Мне кажется, что это больше связано с твоим братом, чем с Райном."
...
translate russian v11_imre_and_ryan_17347e04:
    ...
    imre "Нет, это связано с тем, что они все говорят гадости о моем брате, а Райн не может признаться в этом."
...
translate russian v11_imre_and_ryan_04c65e5f:
    ...
    ry "Если ты закончил нести чушь, Убер будет через две минуты. Один был неподалеку."
...
translate russian v11_imre_and_ryan_6a4effd0:
    ...
    ry "Ты можешь сидеть сзади с плаксой."
...
translate russian v11_imre_and_ryan_62cca7a1:
    ...
    u "(*Вздох* Я начинаю понимать, о чем говорил мистер Ли)."

translate russian strings:

    # game/v11/scene37a.rpy:8
    old "Ride with Mr. Lee"
    new "Прокатится с мистером Ли"
    ...
    new "Нести ответственность"

    # game/v11/scene37a.rpy:128
    old "Acting mature"
    new "Вести по-взрослому"
