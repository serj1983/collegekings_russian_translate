...
translate russian v11_bar_chloe_and_aubrey_095e79b8:
    ...
    charli "Это просто завораживает, насколько ты самовлюбленный человек и как тяжело ты отклоняешься."
...
translate russian v11_bar_chloe_and_aubrey_4780d5ba:
    ...
    charli "Сначала ты думал, что я был добр к девушкам с тайным умыслом, но теперь, когда ты знаешь, что я гей, ты потеряли способность соединять эти точки."
...
translate russian v11_bar_chloe_and_aubrey_e098462d:
    ...
    charli "Ты не можешь понять, как быть добрым без повестки дня, потому что ты сам не добр без повестки дня."

# game/v11/scene33.rpy:36
translate russian v11_bar_chloe_and_aubrey_b5487278:

    # u "(I am a nice guy... agenda my ass.)"
    u "(Я хороший парень... повестка дня - моя задница)."
...
translate russian v11_bar_chloe_and_aubrey_2a47846d:
    ...
    au "Эй, мы в отпуске и пользуемся тем, что находимся в стране, где это законно."
...
translate russian v11_bar_chloe_and_aubrey_5977bbdb:
    ...
    au "Ну, он завалил меня на первом курсе. Я была ужасной ученицей, но я так разозлилась, когда он меня завалил. Он делал всё по принципу - зачет или незачет, и я не сдала одно задание."
...
translate russian v11_bar_chloe_and_aubrey_926e75af:
    ...
    au "Ну, ты только посмотри на это! Я кому-то нужна, так что мне нужно идти... Вам двоим нравится соглашаться друг с другом. *Хихикает*"
...
translate russian v11_bar_chloe_and_aubrey_0300f20a:
    ...
    u "Битва между медведем и гориллой, кто победит?"
...
translate russian v11_bar_chloe_and_aubrey_8f96013b:
    ...
    cl "*Вздох* Не знаю, наверное, горилла. Что за глупый вопрос?"
...
translate russian v11_bar_chloe_and_aubrey_bb9e57e2:
    ...
    cl "Ну, конечно... ты разозлил меня некоторое время назад, но я не могу держать обиду или вечно расстраиваться из-за мелочей. Я не Обри. *Хихикает*"
...
translate russian v11_bar_chloe_and_aubrey_51818979:
    ...
    u "Тогда почему ты так странно ведешь себя со мной?"
...
translate russian v11_bar_chloe_and_aubrey_9435ed09:
    ...
    u "Посмотрите на нас сейчас, это было не так уж сложно. Тебе больше не нужно ходить и постоянно злиться."
...
translate russian v11_bar_chloe_and_aubrey_87fb87b4:
    ...
    cl "У тебя был захватывающий день в отпуске?"
...
translate russian v11_bar_chloe_and_aubrey_e3c20fd9:
    ...
    u "Отпуск был насыщенн событиями. А ты во что ты ввязалась?"
...
translate russian v11_bar_chloe_and_aubrey_d22f26e8:
    ...
    cl "Ты, наверное, не знаешь, но я автомобили. Знаете, такие быстрые спортивные машины и всё такое?"
...
translate russian v11_bar_chloe_and_aubrey_45ecdbb5:
    ...
    cl "Прямо за углом есть дилерский центр, в котором мистер Ли арендовал свою машину, и у них есть очень крутая машина, на которой бы я, с удовольствием, прокатилась."
...
translate russian v11_bar_chloe_and_aubrey_bdb1787c:
    ...
    cl "Я думала, покататься и испытать машинку, но я не хотела ехать одна, а Обри отказалась, потому что слишком много выпила..."
...
translate russian v11_bar_chloe_and_aubrey_b7b27c0f:
    ...
    u "Ну, я даже не притронулся к своему напитку, так что если ты чувствуешь себя достаточно хорошо, я не против поехать с тобой."
...
translate russian v11_bar_chloe_and_aubrey_bf9345a2:
    ...
    cl "Правда? Боже мой, спасибо! Я сейчас вернусь."
...
translate russian v11_bar_chloe_and_aubrey_68ed7eff:
    ...
    bartender "Конечно, так и есть... Небольшой совет? Если ты хочешь, чтобы такая девушка, как она, была с тобой, ты должен надеть на неё кольцо. Или подари ей ребенка."
...
translate russian v11_bar_chloe_and_aubrey_2edef5a1:
    ...
    u "Лаааадно, на сегодня достаточно советов от бармена."
