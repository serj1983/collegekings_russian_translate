...
translate russian v11_big_ben_8375115c:
    ...
    u "Так что я почти ничего не знаю о Лондоне..."
...
translate russian v11_big_ben_639f167f:
    ...
    no "Когда люди говорят, что они ничего не знают, это либо означает, что они действительно ничего не знают, либо почти ничего не знают."
...
translate russian v11_big_ben_9662d24a:
    ...
    no "Ты не смотрел ничего перед поездкой? *Хихикает*"
...
translate russian v11_big_ben_31b2e40a:
    ...
    no "Хаха, позвольте мне проинформировать тебя. Первое, что тебе нужно знать, это то, что Лондон находится под властью королевы."
...
translate russian v11_big_ben_2dee8c8c:
    ...
    no "Водители черных такси должны проходить тест под названием \"Знание\", который заставляет их запомнить все улицы столицы."

# game/v11/scene24.rpy:94
translate russian v11_big_ben_6f62bb16:

    # no "It takes years for some of them to pass."
    no "Для того чтобы некоторые из них прошли, требуются годы."
...
translate russian v11_big_ben_f4771d53:
    ...
    no "Черные такси, а не черные водители."
...
translate russian v11_big_ben_d713fad3:
    ...
    u "Рад, что ты объяснила, потому что я немного запутался. *Хихикает*"

# game/v11/scene24.rpy:114
translate russian v11_big_ben_5e01fd9e:

    # no "That would be terrible."
    no "Это было бы ужасно."
...
translate russian v11_big_ben_50c05486:
    ...
    no "Да, но они слишком дорогие *Хихикает* Давай просто воспользуемся приложением для поездок."

# game/v11/scene24.rpy:149
translate russian v11_big_ben_90e5dc60:

    # no "To the clock tower please."
    no "К часовой башне, пожалуйста."
...
translate russian v11_big_ben_08ba658a:
    ...
    no "Большие часы вон там. *Хихикает*"
...
translate russian v11_big_ben_80e667ba:
    ...
    no "Какое точное время? *Хихикает*"
...
translate russian v11_big_ben_173cc49c:
    ...
    no "*Смеется* Он делает это каждый час без перерыва. Хаха, я не могу поверить, насколько он громкий. Это было прекрасно."
...
translate russian v11_big_ben_8761a971:
    ...
    u "Не буду врать, мне было немного страшно, но это было потрясающе. Я рад, что мне удалось это увидеть."
...
translate russian v11_big_ben_795093be:
    ...
    no "Спасибо тебе за то, что ты хороший человек, за заботу об этой поездке и за заботу обо мне."
...
translate russian v11_big_ben_99aca075:
    ...
    no "Я чувствовала себя безнадежной со всем этим дерьмом, которое происходило. Драма с Крисом, история с Хлоей, столько всего..."

# game/v11/scene24.rpy:304
translate russian v11_big_ben_153edde7:

    # no "But this makes it all worth it."
    no "Но это того стоит."
...
translate russian v11_big_ben_c51fbaff:
    ...
    u "Я чувствовал, что ты заслужила это, это была твоя идея, в конце концов. Я знал, что это много значит для тебя."
...
translate russian v11_big_ben_7d15406e:
    ...
    no "Ты хороший парень, [name]. Извини, что так часто веду себя как сука... Я просто не очень люблю впускать людей."
...
translate russian v11_big_ben_0752ea1c:
    ...
    no "Большинству людей либо на самом деле всё равно, либо у них есть другие мотивы для того, чтобы быть любезными."

# game/v11/scene24.rpy:320
translate russian v11_big_ben_01d84e63:

    # u "Yeah I feel you. Well, that's not me."
    u "Да, я тебя понимаю. Ну, это не я."
...
translate russian v11_big_ben_83517040:
    ...
    no "Я просто хочу, чтобы Крис был больше похож на тебя, вот и всё."
...
translate russian v11_big_ben_61fe533f:
    ...
    no "Ты член братства, студент, ты находишь время для своих друзей, и все же у тебя есть время, чтобы подарить мне такой значимый момент, как этот."

# game/v11/scene24.rpy:350
translate russian v11_big_ben_ca252099:

    # u "Haha, I'm glad you're enjoying yourself Nora."
    u "Хаха, я рад, что тебе нравится, Нора."

# game/v11/scene24.rpy:355
translate russian v11_big_ben_677da55c:

    # no "C'mon, let's head on back before it gets too late."
    no "Пойдем обратно, пока не стало слишком поздно."
...
translate russian v11_big_ben_a2eb4303:
    ...
    no "Ты подумал что?! Что я хочу изменить своему парню? Ух! Почему ты не мог просто побыть хорошим другом?"
...
translate russian v11_big_ben_b34dabda:
    ...
    no "Все парни одинаковые! Ты просто был милым, потому что думал, что получишь немного задницы. Пошел ты, [name]!"
...
translate russian v11_big_ben_5bd398fa:
    ...
    u "Нора прости, я не хотел переходить черту. Мне просто показалось, что у нас был момент."
...
translate russian v11_big_ben_5489b383:
    ...
    u "Я знаю, что вы с Крисом вместе, но ты жаловалась на Криса и все такое. Мне очень жаль, я просто неправильно понял."
...
translate russian v11_big_ben_cca808b5:
    ...
    no "*Вздох* Если я неправильно выразилась, это моя вина? Правда...?"
