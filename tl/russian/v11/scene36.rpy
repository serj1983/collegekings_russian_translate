...
translate russian v11_imre_ryan_grapple_41532f24:
    ...
    ry "Ты сказал это, чтобы быть задницей. И дело даже не в том, как он это сказал. Он прошел мимо меня и сказал \"Эй, маленькая тощая сучка\" ни с того ни с сего, без всякой причины."
...
translate russian v11_imre_ryan_grapple_2e4d9141:
    ...
    ry "Я сказал ему, чтобы он оставил меня в покое и что у меня нет времени на его бредни, тогда он сказал это снова, насмехаясь надо мной, и я выбил из него дерьмо."

# game/v11/scene36.rpy:129
translate russian v11_imre_ryan_grapple_62652cd2:

    # imre "You say it like you actually landed a hit."
    imre "Ты так говоришь, как будто пытался ударить."
...
translate russian v11_imre_ryan_grapple_417a23cd:
    ...
    lee "Это что, ссора, спровоцированная братством?"
...
translate russian v11_imre_ryan_grapple_30f20e16:
    ...
    lee "Кажется, я слышал, как ты сказал, что от Имре пахло мокрой собакой, когда мы были в аэропорту, я ошибаюсь или я прав, Райн?"
...
translate russian v11_imre_ryan_grapple_99b993cc:
    ...
    ry "Да, но это была правда, так что я не вижу в этом проблемы"
...
translate russian v11_imre_ryan_grapple_c83e487a:
    ...
    u "Послушайте, мистер Ли. Можем мы просто списать на то, что мальчики есть мальчики?"
...
translate russian v11_imre_ryan_grapple_b67c4ffc:
    ...
    lee "Вы правы, мальчики будут мальчиками, но такие мужчины, как вы трое, не должны вести себя как мальчики."

# game/v11/scene36.rpy:164
translate russian v11_imre_ryan_grapple_efb11f30:

    # u "(\"Three of you...\", what did I do?)"
    u "(\"Трое из вас...\", что я наделал?)"
...
translate russian v11_imre_ryan_grapple_9be7ae82:
    ...
    lee "Поскольку вы всё хотите вести себя как дети, я буду обращаться с вами как с детьми. Вы трое поедете со мной сегодня утром. Я буду ждать вас в машине, пожалуйста, не задерживайтесь."

# game/v11/scene36.rpy:179
translate russian v11_imre_ryan_grapple_809141c8:

    # u "Look what you guys dragged me into."
    u "Посмотрите, во что вы меня втянули."
...
translate russian v11_imre_ryan_grapple_7e24586b:
    ...
    u "То как мистер Ли разозлился, нет ничего смешного. Я проснулся от ваших криков, а теперь меня тащат неизвестно куда."
...
translate russian v11_imre_ryan_grapple_11c3d5ac:
    ...
    lee "Я хочу, чтобы поездка в машине была спокойной, так что постарайтесь настроиться на расслабляющий лад. Поехали."
